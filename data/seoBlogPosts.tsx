...
export const getSeoBlogPosts = (language: 'pt' | 'es' | 'en', t: any): Post[] => {
  return [
    ...
    },
    {
      ...
      excerpt: 'Saiba como anular uma assembleia de condomínio com irregularidades. Conheça as falhas de convocação, quóruns incorretos e o papel do advogado no RJ.',
      readTime: `15 min ${t('blog_page.read_time_suffix') || 'de leitura'}`,
      category: 'Compliance',
      date: '28 Jun, 2026',
      dateIso: '2026-06-28',
