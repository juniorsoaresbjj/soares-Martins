...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1787168095928.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface FlamengoHonorioDeBarros23AuctionPageProps {
  onBack?: () => void;
}

const FlamengoHonorioDeBarros23AuctionPage: React.FC<FlamengoHonorioDeBarros23AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['flamengo-honorio-de-barros-23-apto-601'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/flamengo/apartamento/rua-honorio-de-barros-23-apto-601/";
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20601%20na%20Rua%20Hon%C3%B3rio%20de%20Barros%2023%20no%20Flamengo."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Honório de Barros, nº 23, Apto 601 — Flamengo, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 281.699 do Cartório do 9º Ofício de Registro de Imóveis do Rio de Janeiro (9º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0714891-9</li>
                <li><strong className="text-white">Área Privativa / Edificada:</strong> 70 metros quadrados (70 m²)</li>
                <li><strong className="text-white">Ano da Construção do Prédio:</strong> 1963 (Construção Residencial Sólida)</li>
                <li><strong className="text-white">Infraestrutura do Edifício:</strong> 4 elevadores, portaria presencial 24 horas e circuito de segurança</li>
                <li><strong className="text-white">Vaga de Garagem:</strong> Segundo o porteiro, embora haja garagem no prédio, o apartamento 601 não tem direito à vaga</li>
                <li><strong className="text-white">Custo Condominial:</strong> Cota reduzida pela ausência de vaga de garagem vinculada</li>
                <li><strong className="text-white">Bairro / Zona:</strong> Flamengo (Zona Sul) — Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 720.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 720.000,00 (08/09/2026 às 15:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (60%):</strong> R$ 432.000,00 (10/09/2026 às 15:00h) — desconto de 40% (R$ 288.000,00 abaixo da avaliação)</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado e Potencial de Valorização no Flamengo
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O Flamengo é um dos bairros mais consolidados e desejados da Zona Sul carioca, unindo qualidade de vida, tradição arquitetônica e excepcional mobilidade urbana. A proximidade com o Aterro do Flamengo (Parque Brigadeiro Eduardo Gomes) proporciona acesso a um dos maiores parques urbanos à beira-mar do mundo, com pistas de corrida, ciclovias, quadras poliesportivas e vasta área verde.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Honório de Barros se caracteriza por ser uma via residencial nobre, sossegada e arborizada, proporcionando tranquilidade para moradia com o benefício de estar a poucos minutos de caminhada de importantes eixos viários, estações de metrô (Metrô Flamengo e Metrô Largo do Machado), supermercados, confeitarias, farmácias, renomadas escolas e centros médicos.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O edifício, construído em 1963, reflete a consagrada arquitetura modernista carioca da década de 60, com pé-direito generoso, 4 elevadores para maior comodidade e portaria 24 horas com controle seguro. A ausência de vaga de garagem vinculada à unidade 601 assegura uma taxa condominial extremamente competitiva para os padrões da Zona Sul, potencializando o yield de rentabilidade para locação residencial tradicional ou de média temporada.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            ...
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação judicial homologada em R$ 720.000,00, a abertura da 2ª praça por R$ 432.000,00 (60% da avaliação) representa um desconto real de R$ 288.000,00 em um apartamento de 70 m² no Flamengo, resultando em um custo por metro quadrado altamente atrativo e com expressiva margem de segurança patrimonial.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A participação no leilão judicial pode ser realizada eletronicamente através do portal do leiloeiro oficial credenciado pelo Tribunal de Justiça do Rio de Janeiro. Para participar com segurança, o arrematante deve efetuar o credenciamento cadastral prévio com antecedência mínima de 24 a 48 horas úteis, submetendo os documentos comprobatórios exigidos no edital.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                O arrematante vencedor efetua o pagamento integral do lance por meio de Guia de Depósito Judicial emitida pelo TJRJ, acrescido da comissão legal do leiloeiro público (5%), no prazo improrrogável estabelecido em edital (normalmente de 24 horas a 3 dias úteis).
              </p>
            </div>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A aquisição de bens em leilão judicial requer rigorosa due diligence imobiliária. O escritório Soares Martins Advogados realiza auditoria jurídica completa sobre a Matrícula nº 281.699 do 9º RGI/RJ, verificação de débitos tributários de IPTU (nº 0714891-9), levantamento minucioso de débitos condominiais e exame aprofundado dos autos processuais perante o TJRJ, assegurando a correta aplicação do art. 130, parágrafo único, do CTN (sub-rogação fiscal no preço) e a célere imissão na posse do arrematante.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria registral no 9º RGI, certidões fiscais e tributárias municipais e verificação de nulidades processuais.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição e registro da carta de arrematação no 9º RGI e cumprimento célere do mandado de imissão na posse.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20601%20na%20Rua%20Hon%C3%B3rio%20de%20Barros%2023%20no%20Flamengo."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20do%20apartamento%20601%20na%20Rua%20Hon%C3%B3rio%20de%20Barros%2023%20no%20Flamengo."
                target="_blank"
                rel="noopener noreferrer"
...
export default FlamengoHonorioDeBarros23AuctionPage;
