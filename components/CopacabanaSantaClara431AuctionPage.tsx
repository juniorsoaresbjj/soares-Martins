...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1785854702670.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface CopacabanaSantaClara431AuctionPageProps {
  onBack?: () => void;
}

const CopacabanaSantaClara431AuctionPage: React.FC<CopacabanaSantaClara431AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['copacabana-santa-clara-431'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://www.juniorsadvogados.com.br/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/copacabana/apartamento/rua-santa-clara-431-apto-704/";
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20Santa%20Clara%20431%20Apto%20704%20em%20Copacabana."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Completo:</strong> Rua Santa Clara, nº 431, APARTAMENTO 704, Bloco 4, Condomínio Mirante de Copacabana — Copacabana, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Área Edificada:</strong> 86 metros quadrados (86 m²)</li>
                <li><strong className="text-white">Ano da Construção (Idade):</strong> 1980</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 35.666 do Cartório do 5º Ofício do Registro Geral de Imóveis do Rio de Janeiro (5º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1.439.517-2</li>
                <li><strong className="text-white">Característica do Condomínio:</strong> Condomínio Mirante de Copacabana — Edifício residencial tradicional com portaria, circuito interno de TV e elevadores.</li>
                <li><strong className="text-white">Bairro / Região:</strong> Copacabana — Zona Sul, Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 635.000,00</li>
                <li><strong className="text-white">1º Leilão (100%):</strong> 09/09/2025 às 13:00h — Lance inicial: R$ 635.000,00</li>
                <li><strong className="text-white">2º Leilão (50%):</strong> 11/09/2025 às 12:00h — Lance inicial: R$ 317.500,00 (50% do valor da avaliação)</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Caracterização da Região e Potencial de Investimento Residencial em Copacabana
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Santa Clara é uma das vias transversais mais estratégicas e consolidadas do bairro de Copacabana. O trecho do Condomínio Mirante de Copacabana conecta os moradores diretamente ao polo comercial da Rua Barata Ribeiro e Avenida Nossa Senhora de Copacabana, além do acesso rápido à Estação de Metrô Siqueira Campos.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Com 86 m² de área privativa, o apartamento 704 do Bloco 4 apresenta planta confortável e versátil, típica dos edifícios da década de 1980 em Copacabana. Trata-se de uma tipologia altamente procurada tanto por famílias que buscam residência própria quanto por investidores focados em locação tradicional ou de temporada (Airbnb / temporária).
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Home size={18} /> Desconto de R$ 317,5 Mil na 2ª Praça Judicial
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Avaliado judicialmente em R$ 635.000,00, o imóvel pode ser arrematado na 2ª Praça a partir de R$ 317.500,00 (desconto de 50%). O valor por m² arrematado fica em torno de R$ 3.690/m², patamar extraordinariamente atrativo para a Zona Sul do Rio de Janeiro, garantindo excelente margem de segurança e rentabilidade.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Importância da Assessoria Jurídica Especializada em Leilões de Imóveis
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A aquisição judicial de imóvel em leilão exige uma análise jurídica minuciosa antes da efetivação dos lances. O escritório Soares Martins Advogados realiza auditoria profunda da Matrícula nº 35.666 perante o 5º RGI/RJ, verificação de dívidas fiscais de IPTU (1.439.517-2), débitos condominiais e certidões dos executados no TJRJ, garantindo a perfeita aplicação da sub-rogação dos débitos no valor da arrematação (art. 130 do CTN) e a obtenção célere da Carta de Arrematação e Imissão na Posse.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Análise do edital, Matrícula nº 35.666 (5º RGI), certidões dos executados e levantamento de pendências de IPTU e condomínio.
              </p>
            </div>

            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              <div className="text-bronze font-bold text-sm flex items-center gap-1.5">
                <CheckCircle2 size={16} /> 2. Habilitação & Lances
              </div>
              <p className="text-xs text-text-muted">
                Habilitação segura no portal do leiloeiro e orientação estratégica de lances na 1ª ou 2ª Praça.
              </p>
            </div>

            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              <div className="text-bronze font-bold text-sm flex items-center gap-1.5">
                <CheckCircle2 size={16} /> 3. Guia Judicial & Carta
              </div>
              <p className="text-xs text-text-muted">
                Emissão das guias judiciais, acompanhamento do auto de arrematação e expedição da Carta de Arrematação no TJRJ.
              </p>
            </div>

            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              <div className="text-bronze font-bold text-sm flex items-center gap-1.5">
                <CheckCircle2 size={16} /> 4. Registro & Imissão na Posse
              </div>
              <p className="text-xs text-text-muted">
                Quitação do ITBI, registro no 5º RGI/RJ e pedido judicial de imissão na posse do apartamento.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20Santa%20Clara%20431%20Apto%20704%20em%20Copacabana."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Rua%20Santa%20Clara%20431%20Apto%20704%20em%20Copacabana."
                target="_blank"
                rel="noopener noreferrer"
...
export default CopacabanaSantaClara431AuctionPage;
