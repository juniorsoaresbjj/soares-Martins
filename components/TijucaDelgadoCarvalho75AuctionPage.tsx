...
const TijucaDelgadoCarvalho75AuctionPage: React.FC<TijucaDelgadoCarvalho75AuctionPageProps> = () => {
  ...
  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/tijuca/cobertura/rua-delgado-de-carvalho-75-cobertura-01/";
