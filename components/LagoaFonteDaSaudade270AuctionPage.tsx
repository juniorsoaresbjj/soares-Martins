...
import { 
  ...
  ShieldCheck, FileCheck, Landmark, CheckCircle2, Scale, Store, Sparkles, Waves, Compass
} from 'lucide-react';
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1788437740700.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface LagoaFonteDaSaudade270AuctionPageProps {
  onBack?: () => void;
}

const LagoaFonteDaSaudade270AuctionPage: React.FC<LagoaFonteDaSaudade270AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['lagoa-fonte-da-saudade-270-apto-402'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/lagoa/cobertura/rua-fonte-da-saudade-270-apto-402/";
    ...
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20da%20cobertura%20duplex%20402%20na%20Rua%20Fonte%20da%20Saudade%20270%20na%20Lagoa."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              <h3 className="text-bronze font-serif font-bold text-base flex items-center gap-2">
                <FileCheck size={18} /> Identificação Imobiliária e Compartimentação
              </h3>
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Fonte da Saudade, nº 270, Cobertura Duplex 402 — Lagoa, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Tipologia:</strong> Apartamento de cobertura duplex residencial com terraço e lazer exclusivo</li>
                <li><strong className="text-white">Área Edificada (IPTU):</strong> 308 metros quadrados (308 m²)</li>
                <li><strong className="text-white">Área Útil Estimada (Laudo):</strong> Aproximadamente 390 metros quadrados (~390 m²)</li>
                <li><strong className="text-white">Composição Interna:</strong> 4 suítes, 1 escritório, 2 lavabos, 2 amplas salas (salão principal de ~90 m²), cozinha pequena e completa, dependência de empregada e despensa</li>
                <li><strong className="text-white">Lazer Privativo:</strong> Piscina privativa, sauna, banheira de hidromassagem e terraço com solarium</li>
                <li><strong className="text-white">Vagas de Garagem:</strong> 4 (quatro) vagas no condomínio</li>
                <li><strong className="text-white">Acabamentos:</strong> Piso em porcelanato, cozinha em cerâmica e teto com projeto luminotécnico</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 96157 do Cartório do 2º Ofício de RGI/RJ</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 3118779-2</li>
              </ul>
            </div>

            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              <h3 className="text-bronze font-serif font-bold text-base flex items-center gap-2">
                <Landmark size={18} /> Dados da Execução e Valoração Judicial
              </h3>
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 5.685.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 5.685.000,00 (21/09/2026 às 12:50h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 2.842.500,00 (24/09/2026 às 12:50h) — desconto de R$ 2.842.500,00</li>
                <li><strong className="text-white">Estado de Conservação:</strong> Médio estado, com infiltrações e fissuras em paredes que requerem obras de reforma e pintura (alto potencial de valorização pós-retrofit)</li>
                <li><strong className="text-white">Possibilidade de Parcelamento:</strong> Admissível conforme Artigo 895 do CPC (25% à vista + até 30 parcelas corrigidas)</li>
              </ul>
            </div>
          </div>
        </article>

        {/* Contexto de Mercado e Exclusividade na Fonte da Saudade / Lagoa */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <Store size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado: Nobreza, Exclusividade e Retrofit na Lagoa
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Fonte da Saudade é um dos enclaves mais nobres e arborizados da Lagoa Rodrigo de Freitas, no coração da Zona Sul do Rio de Janeiro. Localizada ao pé do Maciço da Tijuca e a minutos dos principais clubes náuticos, polos gastronômicos e ciclovias do Rio, a região une serenidade bucólica, alta segurança e facilidade de acesso aos bairros de Ipanema, Leblon, Humaitá e Jardim Botânico.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Coberturas duplex com área útil próxima a 400 m² e 4 suítes são ativos imobiliários extremamente escassos na Zona Sul. O mercado de alto padrão carioca costuma precificar coberturas reformadas na Lagoa entre R$ 22.000 e R$ 35.000 por metro quadrado.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O laudo judicial apontou que a cobertura se encontra em médio estado de conservação, exibindo fissuras e pontos de infiltração a serem corrigidos. Longe de ser um obstáculo, essa condição representa o cenário clássico de investimento de alto retorno ("value-add"): o arrematante adquire o ativo com 50% de desconto na 2ª praça (custo de apenas ~R$ 7.288,00 por metro quadrado de área real útil), realiza o retrofit personalizado de arquitetura contemporânea e consolida um patrimônio com valorização de mercado superior a 100%.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Economia Bruta de R$ 2.842.500,00 na 2ª Praça
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com o lance de largada fixado em R$ 2.842.500,00 na 2ª praça, a margem financeira gerada pela arrematação cobre com folga qualquer plano executivo de reforma e modernização, assegurando extraordinária liquidez e segurança patrimonial.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O leilão judicial da cobertura duplex será conduzido por leiloeiro público oficial por meio de plataforma eletrônica homologada pelo TJRJ. Interessados devem habilitar-se previamente com envio de documentação civil ou societária completa com no mínimo 24 a 48 horas de antecedência ao certame.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Pagamento do valor integral do lance arrematado via depósito judicial vinculado aos autos do processo, somado à comissão do leiloeiro oficial (5%) e custas cartorárias para expedição da Carta de Arrematação e cancelamento de eventuais gravames anteriores.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Admissível apresentação prévia de proposta escrita contendo oferta de pelo menos 25% de entrada à vista e o saldo dividido em até 30 (trinta) prestações mensais corrigidas por índice oficial da Justiça, com hipoteca judicial averbada na Matrícula nº 96157 do 2º RGI.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Em coberturas e imóveis de alto padrão na Zona Sul, a auditoria jurídica prévia é indispensável para diagnosticar passivos de condomínio, verificar a eficácia de intimações de cônjuges e credores hipotecários, e blindar o arrematante contra impugnações processuais, garantindo transferência de propriedade limpa e desimpedida.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria na Matrícula nº 96157 (2º RGI), certidões do IPTU nº 3118779-2, débitos de condomínio na Rua Fonte da Saudade e nulidades processuais.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Formulação da tática de lances para 1ª ou 2ª praça, redação de propostas parceladas (Art. 895 CPC) e acompanhamento em tempo real no leiloeiro.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Homologação judicial da arrematação, guia de ITBI, expedição célere da Carta de Arrematação e mandados de cancelamento de penhoras.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Atuação judicial firme para cumprimento do mandado de imissão de posse com Oficial de Justiça e entrega imediata das chaves da cobertura ao arrematante.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-gradient-to-br from-midnight-light to-midnight rounded-3xl p-8 sm:p-12 border border-bronze/30 text-center space-y-6 shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Lagoa%20Rua%20Fonte%20da%20Saudade%20270%20Cobertura%20402"
...
export default LagoaFonteDaSaudade270AuctionPage;
