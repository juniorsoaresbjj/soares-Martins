...
interface LaranjeirasAuctionPageProps {
  onBack?: () => void;
}

const LaranjeirasAuctionPage: React.FC<LaranjeirasAuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['laranjeiras-347'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/laranjeiras/apartamento/rua-das-laranjeiras-347/";
      ...
      <section className="max-w-7xl mx-auto px-6 pb-12 sm:pb-16">
        <div className="bg-midnight-light/40 backdrop-blur-sm rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-bronze/10 border border-bronze/30 text-bronze text-xs font-semibold uppercase tracking-wider mb-6">
            <Gavel size={14} /> Residencial • Laranjeiras/RJ
          </div>
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20das%20Laranjeiras%20347."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua das Laranjeiras, nº 347/407 — Laranjeiras, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 17.752 do Cartório do 9º Ofício de Registro de Imóveis do Rio de Janeiro (9º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0.355.985-3</li>
                <li><strong className="text-white">Área Edificada:</strong> 115 metros quadrados (115 m²)</li>
                <li><strong className="text-white">Distribuição Interna:</strong> 3 quartos, 1 banheiro social, lavabo, sala ampla com piso em madeira, cozinha e área de serviço com pequeno quarto (dependência)</li>
                <li><strong className="text-white">Estado do Imóvel:</strong> Aspecto agradável, aparentemente sem infiltrações</li>
                <li><strong className="text-white">Posição & Vista:</strong> Fundos para a bucólica Rua Sebastião Lacerda</li>
                <li><strong className="text-white">Vaga de Garagem:</strong> Sem direito a vaga de garagem</li>
                <li><strong className="text-white">Ano de Construção do Prédio:</strong> 1961 (Portaria 24 horas, ótimo estado de conservação)</li>
                <li><strong className="text-white">Bairro / Região:</strong> Laranjeiras (Zona Sul) — Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 950.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 950.000,00 (08/09/2026 às 12:20h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 475.000,00 (10/09/2026 às 12:20h) — desconto de 50% do valor avaliado</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Caracterização da Região e Potencial de Investimento na Rua das Laranjeiras
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Laranjeiras é um dos bairros mais nobres, aristocráticos e tradicionais da Zona Sul do Rio de Janeiro. Conhecido por suas ruas arborizadas, palacetes históricos e ambiente familiar, o bairro oferece excepcional qualidade de vida com proximidade ao Parque Guinle, aos bairros do Cosme Velho, Botafogo e Flamengo, além de rápido acesso ao Centro da cidade e às praias da Zona Sul.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O imóvel de 115 m² situado na Rua das Laranjeiras, nº 347/407, possui planta generosa de 3 quartos com sala em piso de madeira natural e posição silenciosa de fundos para a residencial Rua Sebastião Lacerda. Com portaria 24h e estrutura bem conservada de 1961, unidades residenciais com essa metragem na região mantêm alta demanda tanto para moradia própria de famílias quanto para mercado de locação de longo prazo.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            ...
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Avaliado judicialmente em R$ 950.000,00, a abertura da 2ª praça por R$ 475.000,00 estabelece um custo por metro quadrado extraordinariamente atrativo de aproximadamente R$ 4.130/m² em plena Zona Sul carioca — valor substancialmente inferior à média praticada no mercado imobiliário residencial de Laranjeiras.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Nossa auditoria jurídica preventiva realiza o exame detalhado da Matrícula nº 17.752 junto ao Cartório do 9º Ofício de Registro de Imóveis, análise de débitos fiscais sob o IPTU nº 0.355.985-3, verificação de dívidas de cota condominial e conferência dos atos de citação no processo de execução no TJRJ, assegurando a sub-rogação dos débitos tributários no valor do lance (art. 130 do CTN) e garantindo a aquisição imobiliária sem surpresas futuras.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria completa da Matrícula nº 17.752 (9º RGI/RJ), certidões fiscais de IPTU e passivos processuais no TJRJ.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Acompanhamento da assinatura do Auto de Arrematação e pagamento das guias judiciais e comissão.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação, registro definitivo no 9º RGI e imissão célere na posse judicial.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20das%20Laranjeiras%20347."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Rua%20das%20Laranjeiras%20347."
                target="_blank"
                rel="noopener noreferrer"
...
export default LaranjeirasAuctionPage;
