...
interface MaracanaDonaZulmira19AuctionPageProps {
  onBack?: () => void;
}

const MaracanaDonaZulmira19AuctionPage: React.FC<MaracanaDonaZulmira19AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['maracana-dona-zulmira-19'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/maracana/apartamento/rua-dona-zulmira-19-apto-101/";
      ...
      <section className="max-w-7xl mx-auto px-6 pb-12 sm:pb-16">
        <div className="bg-midnight-light/40 backdrop-blur-sm rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-bronze/10 border border-bronze/30 text-bronze text-xs font-semibold uppercase tracking-wider mb-6">
            <Gavel size={14} /> Residencial • Maracanã/RJ
          </div>
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20Dona%20Zulmira%2019%20no%20Maracan%C3%A3."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Dona Zulmira, nº 19, Apto 101 — Maracanã, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 41.819 do Cartório do 10º Ofício de Registro de Imóveis do Rio de Janeiro (10º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1.640.226-5</li>
                <li><strong className="text-white">Área Edificada Total:</strong> 66 metros quadrados (66 m²)</li>
                <li><strong className="text-white">Ano de Construção do Prédio:</strong> 1984</li>
                <li><strong className="text-white">Distribuição Interna:</strong> Apartamento de frente com boa varanda, composto por quarto, sala, banheiro social, cozinha e dependências completas</li>
                <li><strong className="text-white">Infraestrutura do Edifício:</strong> 2 elevadores (social e serviço), 4 câmeras de segurança no térreo e acessos voltados para a rua, e 2 pavimentos de garagem (térreo e 2G)</li>
                <li><strong className="text-white">Lazer do Condomínio:</strong> Playground, salão de festas e churrasqueira</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 406.923,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 406.923,00 (02/09/2026 às 14:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 203.461,50 (09/09/2026 às 14:00h) — Desconto de 50% sobre a avaliação judicial</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado e Atratividade no Maracanã (Zona Norte/RJ)
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O bairro do Maracanã é um dos polos habitacionais mais tradicionais e estrategicamente localizados da Zona Norte do Rio de Janeiro. Próximo ao icônico Estádio do Maracanã, à Universidade do Estado do Rio de Janeiro (UERJ) e com farta oferta de transporte público (estações de metrô e trem, além de diversas linhas de ônibus), a região apresenta altíssima demanda por locação e compra de imóveis residenciais.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Dona Zulmira é uma via residencial de perfil tranquilo, próxima a comércios, supermercados, farmácias e hospitais. O apartamento de 66 m², por contar com posição de frente, varanda e planta funcional com dependências, possui excelente liquidez para moradia ou investimento em renda de aluguel.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base">
              Oportunidade na 2ª Praça: Aquisição por R$ 203.461,50 (50% do Valor de Avaliação)
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Adquirir um imóvel de 66 m² com varanda e lazer completo no condomínio por R$ 203.461,50 representa um valor de metro quadrado imbatível na região do Maracanã. A arrematação por metades do valor da avaliação judicial oferece margem de segurança patrimonial excepcional para investidores e compradores finais.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Lances na 1ª praça (02/09/2026 às 14h) ou 2ª praça (09/09/2026 às 14h). Também é possível protocolar proposta de pagamento parcelado (Art. 895 do CPC - 25% de entrada + até 30 meses).
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Após a arrematação, efetua-se a lavratura do auto, recolhimento do ITBI, expedição da Carta de Arrematação para registro no 10º RGI e imissão na posse pacífica.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A aquisição de imóveis em leilão judicial exige análise detalhada da Matrícula nº 41.819 (10º RGI/RJ), verificação de certidões do processo de execução, intimação regular das partes e auditoria de eventuais dívidas tributárias e condominiais para garantir a plena segurança jurídica do investimento.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Registro no 10º RGI/RJ e imissão do arrematante na posse do apartamento.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20Dona%20Zulmira%2019%20no%20Maracan%C3%A3."
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-text-muted leading-relaxed">
              ...
              <div className="p-4 bg-midnight rounded-xl border border-white/5 space-y-1">
                ...
                <div>Matrícula nº 41.819 do 10º RGI/RJ • IPTU nº 1.640.226-5</div>
              </div>
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20do%20apartamento%20no%20Maracan%C3%A3."
                target="_blank"
                rel="noopener noreferrer"
...
export default MaracanaDonaZulmira19AuctionPage;
