...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1790003647930.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface BotafogoGeneralGoesMonteiro8AuctionPageProps {
  onBack?: () => void;
}

const BotafogoGeneralGoesMonteiro8AuctionPage: React.FC<BotafogoGeneralGoesMonteiro8AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['botafogo-general-goes-monteiro-8-bloco-f-apto-203'];
  const item = (editalEntry && editalEntry[language]) ? editalEntry[language] : (editalEntry ? editalEntry.pt : {
    ...
    description: 'Apartamento residencial com 94 m² de área privativa no 2º andar (unidade 203 do Bloco F) de consagrado condomínio residencial na Rua General Góes Monteiro nº 8, no cobiçado bairro de Botafogo, Zona Sul do Rio de Janeiro.',
    checklist: [],
    modal: { title: 'Resumo Estruturado do Edital', sections: [] },
    faqs: []
  });

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/botafogo/apartamento/rua-general-goes-monteiro-8-bloco-f-apto-203/";
  ...
  const pageSchema = [
    ...
    },
    {
      ...
      "category": "Real Estate / Judicial Auction / Botafogo RJ",
      "offers": {
        "@type": "AggregateOffer",
        "priceCurrency": "BRL",
        "lowPrice": "564000.00",
        "highPrice": "1128000.00",
        "offerCount": "2",
        "availability": "https://schema.org/InStock",
        "validFrom": "2026-10-19T12:20:00-03:00"
      }
    },
    {
      "@context": "https://schema.org",
      ...
      "validThrough": "2026-10-22T18:00:00-03:00",
      "image": buildingImage,
      "containedInPlace": {
        "@type": "Place",
        "name": "Condomínio Residencial Morada Carioca — Rua General Góes Monteiro 8",
        "address": {
          "@type": "PostalAddress",
          "streetAddress": "Rua General Góes Monteiro, 8, Bloco F, Apto 203",
          "addressLocality": "Rio de Janeiro",
          "addressRegion": "RJ",
          "postalCode": "22290-080",
          "addressCountry": "BR"
        },
        "geo": {
          "@type": "GeoCoordinates",
    ...
    },
    {
      ...
      "areaServed": ["Rio de Janeiro", "Botafogo", "Zona Sul RJ", "Região Metropolitana RJ"],
      "priceRange": "$$$"
    },
    {
      "@context": "https://schema.org",
    ...
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20203%20do%20Bloco%20F%20na%20Rua%20General%20G%C3%B3es%20Monteiro%208%20em%20Botafogo%20-%20RJ."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              <h3 className="text-bronze font-serif font-bold text-base flex items-center gap-2">
                <FileCheck size={18} /> Identificação Imobiliária e Planta
              </h3>
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço:</strong> Rua General Góes Monteiro, nº 8, Bloco F, Apto 203 — Botafogo, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Área Edificada Privativa:</strong> 94 metros quadrados (94 m²)</li>
                <li><strong className="text-white">Vista Privilegiada:</strong> Vista direta e frontal para o Pão de Açúcar (privilégio das terminações final 3 e 4 do Bloco F)</li>
                <li><strong className="text-white">Distribuição Interna:</strong> Sala de estar e jantar, 3 quartos, 2 banheiros sociais, cozinha espaçosa, área de serviço e dependência de serviço completa (quartinho e banheirinho)</li>
                <li><strong className="text-white">Vagas de Garagem:</strong> 1 vaga coberta de garagem + 1 vaga externa para convidado/visitante</li>
                <li><strong className="text-white">Ano de Construção:</strong> Construído em 1974</li>
                <li><strong className="text-white">Estrutura do Condomínio:</strong> 7 blocos residenciais (de A a G), cada um com 25 andares e 4 apartamentos por andar</li>
                <li><strong className="text-white">Lazer e Convivência:</strong> 2 piscinas (1 adulta perto do bloco A e 1 de criança perto do bloco B), 1 parquinho infantil e 1 quadra poliesportiva (ambos no bloco B), bosque privativo com área verde e mercadinho de conveniência</li>
                <li><strong className="text-white">Eventos e Festas:</strong> Cada um dos 7 blocos possui seu próprio salão de festas exclusivo</li>
                <li><strong className="text-white">Portaria e Segurança:</strong> Vigilância interna com rondas, garagista dedicado, portaria exclusiva com porteiro presencial em cada bloco e guarita de segurança 24h na entrada do condomínio</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Devidamente registrado, dimensionado e caracterizado no 3º Ofício de Registro de Imóveis sob a matrícula nº 52.894</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1.245.048-2 (Prefeitura da Cidade do Rio de Janeiro)</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 1.128.000,00 (homologado judicialmente)</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 1.128.000,00 (19/10/2026 às 12:20h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 564.000,00 (22/10/2026 às 12:20h) — deságio direto de R$ 564.000,00</li>
                ...
                <li><strong className="text-white">Custo por m² na 2ª Praça:</strong> Apenas R$ 6.000,00/m² em plena Zona Sul carioca com vista Pão de Açúcar</li>
                <li><strong className="text-white">Modalidades de Pagamento:</strong> Pagamento à vista via depósito judicial ou proposta de parcelamento com garantia hipotecária (Art. 895 do CPC)</li>
              </ul>
            </div>
          </div>
        </article>

        {/* Contexto de Mercado: Botafogo, Zona Sul do Rio */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <Sparkles size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado: Botafogo, Vista Pão de Açúcar e Oportunidade por Metro Quadrado
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Botafogo é um dos bairros mais vibrantes, cosmopolitas e valorizados da Zona Sul do Rio de Janeiro, combinando uma completa rede de comércio, colégios renomados, hospitais de excelência e opções gastronômicas com facilidade de locomoção imediata para Copacabana, Urca, Flamengo e o Centro da Cidade. A Rua General Góes Monteiro está estrategicamente posicionada ao lado do Shopping Rio Sul e do polo universitário da UFRJ/UNIRIO, com acesso rápido ao Túnel Novo e à Enseada de Botafogo.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O condomínio na Rua General Góes Monteiro 8 é um verdadeiro oásis urbano. Terrenos dessa magnitude na Zona Sul são impossíveis de reproduzir hoje: 7 torres em um terreno generoso que abriga um bosque privativo arborizado, duas piscinas, quadra esportiva, parquinho infantil, mercadinho interno para compras rápidas sem sair do condomínio, salão de festas privativo em cada prédio, vigilância 24 horas e garagistas. Além disso, a unidade 203 do Bloco F reúne dois diferenciais raríssimos: a cobiçada vista frontal para o Pão de Açúcar e a disponibilidade de 2 vagas (uma coberta e uma para convidados).
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Em termos de investimento e retorno patrimonial, o deságio da 2ª praça judicial é estarrecedor: abrir a <strong>R$ 564.000,00</strong> para 94 m² com 3 quartos representa um custo de apenas <strong>R$ 6.000,00 por metro quadrado</strong>. Em Botafogo, imóveis residenciais de 3 quartos com vaga e infraestrutura de lazer variam rotineiramente no mercado convencional entre <strong>R$ 13.000,00 e R$ 18.000,00/m²</strong>.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Economia Real de R$ 564.000,00 e Margem Patrimonial Inigualável
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              O deságio de 50% conferido pela 2ª praça confere ao arrematante uma margem de segurança excepcional, assegurando que, mesmo considerando eventuais custos de modernização e taxas de arrematação, o investimento será concluído com expressivo ganho de capital imediato.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O leilão judicial será realizado eletronicamente pelo portal do leiloeiro público oficial designado pelo Tribunal de Justiça do Rio de Janeiro. Para ofertar lances ou submeter propostas formais de aquisição, o participante deve estar homologado perante o leiloeiro com antecedência mínima de 48 horas.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Depósito do valor do lance vencedor por meio de guia judicial vinculada ao processo no TJRJ no prazo estipulado pelo edital (ordinariamente em 24h), acrescido da comissão de 5% do leiloeiro público e custas de expedição.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Apresentação de proposta formal nos autos antes da abertura do leilão: entrada mínima de 25% (R$ 141.000,00 na 2ª praça) e o saldo dividido em até 30 parcelas mensais corrigidas por índice oficial da Justiça, gravando-se hipoteca judicial na matrícula nº 52.894 do 3º RGI.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A arrematação judicial constitui aquisição originária de propriedade, que tem o condão de purgar penhoras e hipotecas anteriores. No entanto, a segurança patrimonial integral do arrematante exige due diligence processual minuciosa: conferência das intimações dos executados, apuração de passivos condominiais, verificação das certidões dos distribuidores e a estrita aplicação da sub-rogação do IPTU prevista no art. 130 do Código Tributário Nacional.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria minuciosa da Matrícula 52.894 do 3º RGI, certidões dos distribuidores cíveis e fiscais, legalidade do edital e IPTU nº 1.245.048-2.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Habilitação perante o leiloeiro oficial, redação de proposta de parcelamento pelo Art. 895 do CPC se aplicável, e teto orçamentário.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Acompanhamento da assinatura do Auto de Arrematação, cálculo do ITBI do Rio de Janeiro e expedição de ofícios para baixa de gravames.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação para registro no 3º RGI e cumprimento do Mandado de Imissão na Posse com suporte presencial.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20203%20do%20Bloco%20F%20na%20Rua%20General%20G%C3%B3es%20Monteiro%208%20em%20Botafogo%20-%20RJ."
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Botafogo%20Rua%20General%20Goes%20Monteiro%208%20Bl%20F%20Apto%20203" 
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Rua%20General%20G%C3%B3es%20Monteiro%208%20em%20Botafogo%20-%20RJ."
                target="_blank"
                rel="noopener noreferrer"
...
export default BotafogoGeneralGoesMonteiro8AuctionPage;
