...
interface CopacabanaMascarenhasMorais190AuctionPageProps {
  onBack?: () => void;
}

const CopacabanaMascarenhasMorais190AuctionPage: React.FC<CopacabanaMascarenhasMorais190AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['copacabana-mascarenhas-morais-190'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/copacabana/apartamento/rua-marechal-mascarenhas-de-morais-190-apto-703/";
    ...
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 pb-12 sm:pb-16">
        <div className="bg-midnight-light/40 backdrop-blur-sm rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-bronze/10 border border-bronze/30 text-bronze text-xs font-semibold uppercase tracking-wider mb-6">
            <Gavel size={14} /> Residencial • Copacabana/RJ
          </div>
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20Marechal%20Mascarenhas%20de%20Morais%20190%20em%20Copacabana."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Marechal Mascarenhas de Morais, nº 190, Apto 703 — Copacabana, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 49.437, Livro nº 2º/7, Fls. 174 do Cartório do 5º Ofício de Registro de Imóveis do Rio de Janeiro (5º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1.534.550-7</li>
                <li><strong className="text-white">Área Edificada Total:</strong> 79 metros quadrados (79 m²)</li>
                <li><strong className="text-white">Ano de Construção do Prédio:</strong> 1982</li>
                <li><strong className="text-white">Estrutura do Edifício:</strong> Sete andares e um andar de cobertura, com quatro apartamentos por andar e uma cobertura</li>
                <li><strong className="text-white">Infraestrutura do Condomínio:</strong> Vaga de garagem, 3 elevadores, serviço de portaria 24 horas e sistema completo de monitoramento por câmeras de segurança em todo o prédio</li>
                <li><strong className="text-white">Lazer do Condomínio:</strong> Playground com salão de festas</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 1.091.500,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 1.091.500,00 (17/09/2026 às 12:20h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 545.750,00 (22/09/2026 às 12:20h) — Desconto de 50% sobre a avaliação judicial</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Localizada a poucas quadras da Praia de Copacabana e próxima à estação de metrô Siqueira Campos ou Cardeal Arcoverde, a Rua Marechal Mascarenhas de Morais é uma via estritamente residencial e valorizada na Zona Sul carioca. O bairro combina infraestrutura urbana completa, com farta rede de supermercados, restaurantes, farmácias, instituições de ensino e facilidade de acesso a Botafogo, Ipanema e ao Centro do Rio.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O apartamento de 79 m² em edifício de porte médio (4 unidades por andar, 3 elevadores, garagem, portaria 24h e lazer) oferece excelente relação custo-benefício e elevadíssima liquidez tanto para moradia própria quanto para investimento em locação residencial de longa duração ou temporada.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base">
              Oportunidade na 2ª Praça: Aquisição por R$ 545.750,00 (50% do Valor de Avaliação)
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Arrematar um apartamento de 79 m² em Copacabana por R$ 545.750,00 resulta em um valor por metro quadrado de aproximadamente R$ 6.908/m², patamar extraordinariamente abaixo da média de mercado praticada na Zona Sul, garantindo uma margem de segurança e rentabilidade patrimonial excepcional.
            </p>
          </div>
        </article>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Cadastramento e envio de documentação no portal do leiloeiro oficial credenciado junto ao TJRJ com antecedência de 24 a 48 horas do início das praças.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Lances na 1ª praça (17/09/2026 às 12:20h) ou 2ª praça (22/09/2026 às 12:20h). Também é possível protocolar proposta de pagamento parcelado (Art. 895 do CPC - 25% de entrada + até 30 meses).
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Após a arrematação, efetua-se a lavratura do auto, recolhimento do ITBI, expedição da Carta de Arrematação para registro no 5º RGI e imissão na posse pacífica.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A arrematação de imóveis em leilão exige auditoria prévia da Matrícula nº 49.437 (5º RGI/RJ), verificação de certidões do processo de execução, intimação regular das partes e avaliação de possíveis débitos fiscais ou condominiais para assegurar a tranquilidade do arrematante.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Análise minuciosa da matrícula, certidões fiscais, débitos de condomínio e edital.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Parecer de viabilidade econômica e jurídica para atuação nas praças ou proposta parcelada.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Supervisão de guias de depósito, guia de ITBI e expedição da Carta de Arrematação.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Registro no 5º RGI/RJ e imissão do arrematante na posse do apartamento.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20Marechal%20Mascarenhas%20de%20Morais%20190%20em%20Copacabana."
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-text-muted leading-relaxed">
              ...
              <div className="p-4 bg-midnight rounded-xl border border-white/5 space-y-1">
                ...
                <div>Matrícula nº 49.437 (Livro 2º/7, Fls. 174) do 5º RGI/RJ • IPTU nº 1.534.550-7</div>
              </div>
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20do%20apartamento%20na%20Rua%20Marechal%20Mascarenhas%20de%20Morais%20190."
                target="_blank"
                rel="noopener noreferrer"
...
export default CopacabanaMascarenhasMorais190AuctionPage;
