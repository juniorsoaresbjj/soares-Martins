...
import { 
  ...
  ShieldCheck, FileCheck, Landmark, CheckCircle2, Scale, Sun, Home, Shield, Sparkles
} from 'lucide-react';
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1790260486772.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface BotafogoLauroMuller36Apto109AuctionPageProps {
  onBack?: () => void;
}

const BotafogoLauroMuller36Apto109AuctionPage: React.FC<BotafogoLauroMuller36Apto109AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['botafogo-lauro-muller-36-apto-109'];
  const item = (editalEntry && editalEntry[language]) ? editalEntry[language] : (editalEntry ? editalEntry.pt : {
    ...
    description: 'Apartamento residencial de 38 m² de área edificada privativa correspondente à unidade 109, situado em posição de fundos e atualmente desocupado de pessoas, no condomínio da Rua Lauro Müller nº 36, no estratégico e valorizado bairro de Botafogo, Zona Sul do Rio de Janeiro.',
    checklist: [],
    modal: { title: 'Resumo Estruturado do Edital', sections: [] },
    faqs: []
  });

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/botafogo/apartamento/rua-lauro-muller-36-apto-109/";
  ...
  const pageSchema = [
    ...
    },
    {
      ...
      "image": [
        "https://soaresmartinsadv.com/src/assets/images/regenerated_image_1790260486772.png"
      ],
      "offers": {
        "@type": "AggregateOffer",
        "priceCurrency": "BRL",
        ...
        "offers": [
          {
            ...
            "price": "500000.00",
            "priceCurrency": "BRL",
            "validFrom": "2026-11-13T11:00:00-03:00",
          ...
          },
          {
            ...
            "price": "250000.00",
            "priceCurrency": "BRL",
            "validFrom": "2026-11-23T11:00:00-03:00",
            "availability": "https://schema.org/InStock",
            "url": canonicalUrl
          }
        ]
    ...
    },
    {
      ...
      "url": canonicalUrl,
      "image": "https://soaresmartinsadv.com/src/assets/images/regenerated_image_1790260486772.png",
      "datePosted": "2026-09-24",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "Rua Lauro Müller, nº 36, Apto 109",
    ...
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
        ...
        <div className="bg-midnight-light/40 backdrop-blur-sm rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl">
          <div className="flex flex-wrap items-center gap-2 mb-6">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/90 text-xs font-medium">
              <Building2 size={13} className="text-bronze" /> 38 m² • Posição Fundos
            </div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-medium">
              <Sparkles size={13} className="text-emerald-400" /> Imóvel Desocupado de Pessoas
            </div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/90 text-xs font-medium">
              <Home size={13} className="text-bronze" /> Prédio Residencial 16 Andares • 3 Elevadores
            </div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/90 text-xs font-medium">
              <Shield size={13} className="text-bronze" /> Portaria 24h & Câmeras CFTV 24h
            </div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/90 text-xs font-medium">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20109%20na%20Rua%20Lauro%20M%C3%BCller%2036%20em%20Botafogo%20-%20RJ."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Lauro Müller, nº 36, Apto 109 — Botafogo, Rio de Janeiro/RJ (CEP: 22290-160)</li>
                <li><strong className="text-white">Unidade Imobiliária:</strong> Apartamento nº 109 do condomínio</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 56.285 do Cartório do 3º Ofício de Registro de Imóveis do Rio de Janeiro (3º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1205828-5</li>
                <li><strong className="text-white">Área Edificada Privativa:</strong> 38 metros quadrados (38 m²)</li>
                <li><strong className="text-white">Posição da Unidade:</strong> Fundos — proporcionando acústica calma, privacidade e isolamento dos ruídos urbanos</li>
                <li><strong className="text-white">Estado de Ocupação:</strong> Imóvel desocupado de pessoas (garantindo imissão célere e sem entraves de despejo)</li>
                <li><strong className="text-white">Estrutura do Edifício:</strong> Edifício constituído de 16 andares, possuindo 12 apartamentos por andar</li>
                <li><strong className="text-white">Destinação do Condomínio:</strong> Exclusivamente residencial</li>
                <li><strong className="text-white">Verticalização e Acesso:</strong> Atendido por 3 (três) elevadores modernizados</li>
                <li><strong className="text-white">Segurança Condominial:</strong> Portaria presencial 24 horas e sistema de monitoramento por câmeras de segurança (CFTV) 24 horas</li>
                <li><strong className="text-white">Área Social & Lazer:</strong> Salão de festas na cobertura com ampla vista para a cidade e a enseada</li>
                <li><strong className="text-white">Bairro / Zona:</strong> Botafogo — Zona Sul da Cidade do Rio de Janeiro</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 500.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 500.000,00 (13/11/2026 às 11:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 250.000,00 (23/11/2026 às 11:00h) — deságio de 50% (~R$ 6.578,95/m²)</li>
                ...
                <li><strong className="text-white">Condições de Pagamento:</strong> À vista em 24h ou parcelado judicial sob o Art. 895 do CPC (25% de sinal e até 30 meses corrigidos com hipoteca judicial)</li>
                <li><strong className="text-white">Sub-rogação Tributária:</strong> Débitos de IPTU e taxas municipais anteriores sub-rogam-se sobre o preço arrematado (Art. 130, parágrafo único, do CTN)</li>
                <li><strong className="text-white">Auditoria Condominial:</strong> Exame prévio de cotas e habilitação do condomínio no processo para resguardar o arrematante</li>
              </ul>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Lauro Müller desfruta de um posicionamento geográfico altamente privilegiado dentro do bairro de Botafogo. Localizada na transição imediata para a Urca, a Enseada de Botafogo e o bairro de Copacabana, a via fica a poucos passos do Rio Sul Shopping Center — um dos maiores e mais completos centros de compras, gastronomia e negócios da Zona Sul — e das sedes universitárias da UFRJ (Campus Praia Vermelha) e UNIRIO, além de centros médicos e empresariais conceituados.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Unidades residenciais compactas de 38 m² nessa região possuem uma das maiores taxas de ocupação e liquidez da cidade. São procuradas tanto por profissionais de empresas multinacionais e do polo corporativo de Botafogo quanto por estudantes universitários e locatários temporários (AirBnb e locação executiva), gerando rendimento contínuo de aluguel e alta proteção inflacionária.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
              <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
                <Home size={18} /> Metro Quadrado em 2ª Praça: ~R$ 6.578/m²
              </div>
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Em Botafogo, o valor de venda de apartamentos residenciais prontos varia entre R$ 13.000,00 e R$ 16.000,00/m². O lance inicial de 2ª praça fixado em R$ 250.000,00 projeta um custo de aquisição de apenas ~R$ 6.578,95/m², gerando um deságio real próximo de 50% em relação aos imóveis comercializados no bairro.
              </p>
            </div>
            ...
            <div className="p-6 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl space-y-2">
              <div className="text-emerald-400 font-serif font-bold text-base flex items-center gap-2">
                <Sparkles size={18} /> Imóvel Desocupado: Posse e Rentabilidade Imediata
              </div>
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Por encontrar-se formalmente desocupado de pessoas, o arrematante não enfrentará litígios de reintegração nem longos prazos de desocupação coercitiva, permitindo pronta reforma, modernização e disponibilização do apartamento para locação ou revenda lucrativa.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A participação no leilão judicial da Rua Lauro Müller nº 36 ocorre perante o leiloeiro público designado pelo Tribunal de Justiça do Estado do Rio de Janeiro. O Código de Processo Civil viabiliza duas alternativas para arrematação:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                O arrematante deposita o valor integral de seu lance em conta judicial vinculada ao processo no prazo legal de até 24 horas após a batida do martelo, além da comissão de 5% devida ao leiloeiro oficial. A proposta à vista tem primazia legal sobre ofertas parceladas.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                O interessado pode protocolar nos autos judiciais proposta escrita antes da abertura do pregão para pagamento com entrada mínima de 25% (R$ 62.500,00 na 2ª praça) e o saldo dividido em até 30 parcelas mensais corrigidas por índice da Justiça estadual, com hipoteca judicial averbada na própria Matrícula nº 56.285.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A assessoria jurídica imobiliária da Soares Martins Advogados proporciona segurança integral para o investidor ou futuro morador, conduzindo a auditoria completa da Matrícula nº 56.285 no 3º Ofício de Registro de Imóveis, verificando a regularidade das citações e intimações dos devedores e terceiros interessados nos autos do TJRJ, estruturando a melhor estratégia de lance e acompanhando os trâmites até a imissão formal na posse.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria registral minuciosa da Matrícula 56.285 no 3º RGI, certidões fiscais (IPTU 1205828-5), débitos de condomínio e verificação de nulidades processuais no TJRJ.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              <div className="text-bronze font-bold text-sm flex items-center gap-1.5">
                <CheckCircle2 size={16} /> 4. Carta & Posse Célere
              </div>
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação, cancelamento de ônus no 3º RGI e cumprimento rápido do Mandado de Imissão na Posse, favorecido pela desocupação da unidade.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20109%20na%20Rua%20Lauro%20M%C3%BCller%2036%20em%20Botafogo%20-%20RJ."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Rua%20Lauro%20M%C3%BCller%2036%20apto%20109%20em%20Botafogo."
                target="_blank"
                rel="noopener noreferrer"
...
export default BotafogoLauroMuller36Apto109AuctionPage;
