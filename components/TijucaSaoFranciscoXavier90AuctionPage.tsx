...
import { 
  ...
  ShieldCheck, FileCheck, Landmark, CheckCircle2, Scale, Car
} from 'lucide-react';
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1785851248282.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface TijucaSaoFranciscoXavier90AuctionPageProps {
  onBack?: () => void;
}

const TijucaSaoFranciscoXavier90AuctionPage: React.FC<TijucaSaoFranciscoXavier90AuctionPageProps> = () => {
    ...
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20503%20na%20Rua%20S%C3%A3o%20Francisco%20Xavier%2090%20na%20Tijuca."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua São Francisco Xavier, nº 90, Apto 503 — Tijuca, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 37.650 do Cartório do 11º Ofício de Registro de Imóveis do Rio de Janeiro (11º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0.072.588-7</li>
                <li><strong className="text-white">Área Edificada / Útil:</strong> 93 metros quadrados (93 m²)</li>
                <li><strong className="text-white">Vagas de Garagem:</strong> 2 (duas) vagas de garagem</li>
                <li><strong className="text-white">Características do Prédio:</strong> Edifício de 7 andares mais cobertura, fachada revestida de pastilhas, 2 lojas no térreo, portaria fechada com portões de ferro</li>
                <li><strong className="text-white">Ano de Construção do Prédio:</strong> 1971</li>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 740.100,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 740.100,00 (09/09/2026 às 12:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 370.100,00 (11/09/2026 às 12:00h) — desconto de 50% do valor da avaliação</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua São Francisco Xavier é uma das vias estruturantes mais consolidadas e procuradas do tradicional bairro da Tijuca. O trecho do número 90 destaca-se pela excelente acessibilidade urbana, com transporte público abundante, proximidade com estações de metrô, universidades (como a UERJ), renomados colégios tradicionais, supermercados, hospitais e o vibrante Polo Gastronômico da Tijuca.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Apartamentos residenciais de 93 m² contando com o diferencial de duas (2) vagas de garagem são raros no mercado tijucano e possuem elevadíssima procura tanto por famílias que buscam moradia de qualidade quanto por investidores com foco em locação de longo prazo e valorização patrimonial na Zona Norte carioca.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Car size={18} /> Oportunidade com 2 Vagas de Garagem e 50% de Desconto na 2ª Praça
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação judicial oficial fixada em R$ 740.100,00, a abertura da 2ª praça por R$ 370.100,00 viabiliza uma aquisição imobiliária com 50% de margem de desconto, representando uma oportunidade altamente rentável no mercado imobiliário da Tijuca.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A arrematação judicial de imóveis exige rigorosa due diligence imobiliária. Nossa banca examina detidamente a Matrícula nº 37.650 do 11º RGI/RJ, consulta débitos de IPTU (0.072.588-7), analisa a saúde financeira do condomínio e a regularidade do processo executivo no TJRJ para resguardar o investidor e assegurar a imissão limpa na posse, sem surpresas com dívidas pregressas (art. 130 do CTN).
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria jurídica completa da matrícula nº 37.650 (11º RGI/RJ), certidões do executado e certidões fiscais de IPTU.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação, registro no 11º RGI e imissão na posse judicial com rapidez e segurança.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20503%20na%20Rua%20S%C3%A3o%20Francisco%20Xavier%2090%20na%20Tijuca."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Rua%20S%C3%A3o%20Francisco%20Xavier%2090%20na%20Tijuca."
                target="_blank"
                rel="noopener noreferrer"
...
export default TijucaSaoFranciscoXavier90AuctionPage;
