...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1788917173417.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface Laranjeiras336AuctionPageProps {
  onBack?: () => void;
}

const Laranjeiras336AuctionPage: React.FC<Laranjeiras336AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['laranjeiras-336-bloco-1-apto-826'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/laranjeiras/apartamento/rua-das-laranjeiras-336-bloco-1-apto-826/";
  ...
  return (
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20826%20na%20Rua%20das%20Laranjeiras%20336%20bloco%201%20em%20Laranjeiras."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Completo:</strong> Rua das Laranjeiras, nº 336, Entrada B, Bloco 1, Apartamento 826 — Laranjeiras, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Bairro e Região:</strong> Laranjeiras — Zona Sul do Rio de Janeiro</li>
                <li><strong className="text-white">Andar e Bloco:</strong> 8º pavimento, Apartamento 826, Bloco 1 (Entrada B)</li>
                <li><strong className="text-white">Área Privativa Edificada:</strong> 24 metros quadrados (24 m²)</li>
                <li><strong className="text-white">Utilização do Imóvel:</strong> Residencial (compacto / estúdio)</li>
                <li><strong className="text-white">Situação de Ocupação:</strong> Imóvel fechado</li>
                <li><strong className="text-white">Vaga de Garagem:</strong> SEM DIREITO A VAGA DE GARAGEM</li>
                <li><strong className="text-white">Ano de Construção:</strong> 1972 (idade de 1972)</li>
                <li><strong className="text-white">Estado de Conservação:</strong> Em bom estado de conservação</li>
                <li><strong className="text-white">Infraestrutura Condominial:</strong> Portaria 24 horas, câmeras de segurança, área para churrasco, capela privativa e bicicletário</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Devidamente registrado, dimensionado e caracterizado no 9º Ofício de Registro de Imóveis do Rio de Janeiro (9º RGI/RJ) sob a matrícula nº 91.053</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0.986.826-6</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 330.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 330.000,00 (22/09/2026 às 14:30h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 165.000,00 (23/09/2026 às 14:30h) — desconto de 50% (economia de R$ 165.000,00)</li>
        ...
        {/* Contexto de Mercado e Oportunidade em Laranjeiras */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <Trees size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado: Laranjeiras, Qualidade de Vida e Liquidez na Zona Sul
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O bairro de Laranjeiras é um dos endereços residenciais mais charmosos, arborizados e tradicionais da Zona Sul carioca. Situado entre o Cosme Velho, Catete e Flamengo, o bairro combina atmosfera residencial bucólica com ampla conveniência urbana, proximidade com o Parque Guinle, Palácio Guanabara, Praça São Salvador, conceituados colégios, hospitais, teatros e polo gastronômico requintado.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O número 336 da Rua das Laranjeiras desfruta de transporte público ágil, linhas de ônibus frequentes na porta e rápido acesso ao Metrô Largo do Machado. Por ser um imóvel compacto de 24 m² em condomínio seguro com portaria 24 horas, bicicletário e lazer com churrasqueira, a unidade possui enorme liquidez tanto para locação convencional quanto para locação flexível a estudantes, residentes médicos e profissionais de empresas da Zona Sul e Centro.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            No mercado tradicional de compra e venda de Laranjeiras, o metro quadrado de apartamentos compactos varia entre <strong>R$ 10.500/m² e R$ 14.000/m²</strong>. Neste certame judicial, a abertura da 2ª praça a <strong>R$ 165.000,00</strong> viabiliza a aquisição por aproximadamente <strong>R$ 6.875 por metro quadrado</strong>, oferecendo uma margem de proteção patrimonial extraordinária para investidores e compradores finais.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Imóvel Fechado e Deságio de 50% na Zona Sul
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              O laudo atesta que a unidade 826 encontra-se fechada, o que reduz substancialmente a complexidade executiva e os prazos de desocupação e imissão na posse em comparação a imóveis com litígios possessórios intensos.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O leilão será realizado de forma eletrônica pelo leiloeiro público oficial designado nos autos da execução no TJRJ. A habilitação exige envio prévio de documentos e aprovação cadastral na plataforma do certame com antecedência mínima de 48 a 72 horas úteis.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Depósito do lance vencedor integralmente mediante guia judicial do Banco do Brasil vinculada ao processo no TJRJ no prazo estipulado pelo edital, além da comissão de 5% do leiloeiro oficial e custas de expedição da Carta de Arrematação.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Apresentação tempestiva de proposta escrita formalizada nos autos antes do início ou encerramento da praça, com sinal mínimo de 25% à vista e o saldo restante dividido em até 30 (trinta) parcelas mensais corrigidas monetariamente, gravando-se hipoteca judicial na matrícula nº 91.053 do 9º RGI.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Mesmo sendo uma aquisição originária que cancela penhoras e hipotecas anteriores na matrícula, a assessoria jurídica especializada previne surpresas processuais, fiscaliza a regularidade das intimações e agiliza a tomada efetiva de posse.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria minuciosa da Matrícula nº 91.053 do 9º RGI, certidões fiscais do IPTU nº 0.986.826-6, débitos condominiais e regularidade do edital de leilão.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Credenciamento no leiloeiro, elaboração técnica de proposta de parcelamento (Art. 895 CPC) e estratégia de lances durante a praça.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Assinatura do auto de arrematação, apuração e recolhimento de ITBI perante a Prefeitura do Rio, expedição da Carta de Arrematação e cancelamento de gravames no 9º RGI.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Petição de cumprimento imediato do Mandado de Imissão na Posse com Oficial de Justiça, abertura do imóvel fechado e entrega definitiva das chaves ao arrematante.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-gradient-to-br from-midnight-light to-midnight rounded-3xl p-8 sm:p-12 border border-bronze/30 text-center space-y-6 shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Laranjeiras%20Rua%20das%20Laranjeiras%20336%20Apto%20826"
...
export default Laranjeiras336AuctionPage;
