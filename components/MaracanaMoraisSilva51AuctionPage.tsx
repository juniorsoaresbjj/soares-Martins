...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1787170135859.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface MaracanaMoraisSilva51AuctionPageProps {
  onBack?: () => void;
}

const MaracanaMoraisSilva51AuctionPage: React.FC<MaracanaMoraisSilva51AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['maracana-morais-e-silva-51-apto-1401'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/maracana/apartamento/rua-morais-e-silva-51-apto-1401/";
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%201401%20Bloco%202%20na%20Rua%20Morais%20e%20Silva%2051%20no%20Maracan%C3%A3."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Morais e Silva, nº 51, Apto 1401, Bloco 2 — Maracanã, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 30.179 do Cartório do 11º Ofício de Registro de Imóveis do Rio de Janeiro (11º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1.514.716-8</li>
                <li><strong className="text-white">Área Privativa / Edificada:</strong> 85 metros quadrados (85 m²)</li>
                <li><strong className="text-white">Pavimento / Posição:</strong> 14º Pavimento (Andar Alto), Bloco 2 — vista livre e excelente ventilação</li>
                <li><strong className="text-white">Vaga de Garagem:</strong> 01 (uma) vaga de garagem destinada, indistintamente, na garagem elevada do mesmo bloco</li>
                <li><strong className="text-white">Estado de Ocupação:</strong> Apartamento fechado</li>
                <li><strong className="text-white">Bairro / Região:</strong> Maracanã / Grande Tijuca (Zona Norte) — Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 610.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 610.000,00 (08/09/2026 às 11:30h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 305.000,00 (10/09/2026 às 14:30h) — desconto de 50% (R$ 305.000,00 abaixo da avaliação)</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado e Mobilidade Urbana no Maracanã
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O Maracanã é um dos bairros mais estratégicos e tradicionais da Zona Norte carioca, integrando o eixo da Grande Tijuca. Famoso mundialmente pelo Estádio Jornalista Mário Filho (Maracanã) e pelo campus universitário da UERJ (Universidade do Estado do Rio de Janeiro), a região combina forte apelo residencial familiar, dinamismo estudantil e infraestrutura urbana de primeiro nível.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Morais e Silva se destaca por sua localização central no bairro, com fácil e rápido deslocamento para o Centro da Cidade, Tijuca, Vila Isabel e Zona Sul via metrô (estações Maracanã e São Francisco Xavier), além de linhas férreas da SuperVia e eixos viários como a Avenida Radial Oeste e Rua São Francisco Xavier.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O apartamento nº 1401, situado no 14º andar do Bloco 2, desfruta do privilégio de um andar alto com luminosidade abundante e privacidade acústica. A inclusão de uma vaga de garagem coberta em estrutura de garagem elevada do próprio bloco agrega considerável liquidez e valor de mercado ao imóvel, atendendo a uma demanda constante de famílias, professores, médicos e profissionais que atuam na região.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Oportunidade com 50% de Desconto na 2ª Praça (Lance Inicial a R$ 305.000,00)
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação homologada em R$ 610.000,00, a abertura da 2ª praça judicial por R$ 305.000,00 (apenas R$ 3.588,00 por metro quadrado para um apartamento de 85 m² com vaga no Maracanã) representa uma margem de segurança patrimonial excepcional e alto potencial de valorização imediata pós-regularização.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                O arrematante pode submeter proposta por escrito para aquisição parcelada: entrada de no mínimo 25% à vista e o saldo restante em até 30 (trinta) parcelas mensais e sucessivas corrigidas, com garantia hipotecária registrada na própria matrícula nº 30.179 do 11º RGI/RJ.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A aquisição em leilão judicial proporciona condições financeiras altamente vantajosas, exigindo contudo análise técnica aprofundada para sanear riscos processuais, despesas de condomínio, ônus reais e regularização da titularidade no cartório competente. Nosso escritório atua em todas as etapas com rigor metodológico:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria na Matrícula nº 30.179 (11º RGI), certidões fiscais do IPTU nº 1.514.716-8, débitos condominiais e regularidade das citações nos autos do TJRJ.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Acompanhamento da assinatura do Auto de Arrematação, expedição da Carta de Arrematação pelo juiz, guias de ITBI e registro definitivo no 11º RGI.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Requerimento célere do Mandado de Imissão na Posse, acompanhamento da diligência com Oficial de Justiça e entrega formal das chaves do imóvel.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-gradient-to-br from-midnight-light to-midnight rounded-3xl p-8 sm:p-12 border border-bronze/30 text-center space-y-6 shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Maracana%20Rua%20Morais%20e%20Silva%2051%20Apto%201401"
...
export default MaracanaMoraisSilva51AuctionPage;
