...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1787769561839.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface RioCompridoPresidenteVargas3555AuctionPageProps {
  onBack?: () => void;
}

const RioCompridoPresidenteVargas3555AuctionPage: React.FC<RioCompridoPresidenteVargas3555AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['rio-comprido-presidente-vargas-3555-apto-403'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/rio-comprido/apartamento/avenida-presidente-vargas-3555-bloco-e-apto-403/";
            ...
            <div className="lg:col-span-7 space-y-3">
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group aspect-[16/10]">
                ...
                <div className="absolute top-4 left-4">
                  <span className="flex items-center gap-1.5 bg-emerald-600/90 text-white font-bold text-xs px-3 py-1.5 rounded-lg border border-emerald-400/40 shadow-lg">
                    <KeyRound size={13} /> IMÓVEL DESOCUPADO (VAZIO)
                  </span>
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  ...
                  <div className="bg-midnight-light/50 p-4 rounded-xl border border-emerald-500/30">
                    ...
                    <div className="text-sm font-semibold text-emerald-300 mb-2">75% da Avaliação</div>
                    <div className="text-xs text-text-muted mb-1">{tC.minBidLabel}</div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20403%20do%20Bloco%20E%20na%20Av.%20Presidente%20Vargas%203555%20no%20Rio%20Comprido%20-%20Rio%20de%20Janeiro."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-midnight-light/30 border border-white/10 rounded-2xl p-5 text-left">
            ...
            <div className="text-xl font-bold text-white mt-1">57 m²</div>
            <div className="text-[11px] text-text-muted mt-0.5">Bloco E • Apto 403 (4º Andar)</div>
          </div>
          <div className="bg-midnight-light/30 border border-white/10 rounded-2xl p-5 text-left">
            <KeyRound className="text-emerald-400 mb-2" size={24} />
            <div className="text-xs text-text-muted uppercase tracking-wider">Status de Ocupação</div>
            <div className="text-xl font-bold text-emerald-400 mt-1">Desocupado (Vazio)</div>
            <div className="text-[11px] text-text-muted mt-0.5">Posse Imediata sem Desocupação</div>
          </div>
          <div className="bg-midnight-light/30 border border-white/10 rounded-2xl p-5 text-left">
            ...
            <div className="text-xl font-bold text-white mt-1">Condomínio Fechado</div>
            <div className="text-[11px] text-text-muted mt-0.5">Portaria, Elevadores e Áreas Comuns</div>
          </div>
          <div className="bg-midnight-light/30 border border-white/10 rounded-2xl p-5 text-left">
            ...
            <div className="text-xl font-bold text-emerald-400 mt-1">R$ 171.000,00</div>
            <div className="text-[11px] text-text-muted mt-0.5">75% da Avaliação Judicial</div>
          </div>
        </div>
      </section>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-midnight-light/20 rounded-2xl p-8 border border-white/10 space-y-4">
              <h2 className="text-2xl font-serif font-bold text-white flex items-center gap-2">
                <FileCheck className="text-bronze" size={24} /> Descrição Detalhada do Imóvel e Conjunto Residencial
              </h2>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                O imóvel objeto de leilão judicial corresponde ao <strong>Apartamento nº 403 do Bloco E</strong>, com <strong>57 m² de área privativa</strong>, integrante do conjunto residencial erguido na <strong>Avenida Presidente Vargas, nº 3555</strong>, no bairro do Rio Comprido / Região Central do Rio de Janeiro/RJ.
              </p>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                O imóvel encontra-se <strong>DESOCUPADO (VAZIO)</strong>, um diferencial altamente vantajoso no mercado de leilões judiciais, pois <strong>elimina a necessidade de ações litigiosas ou demoradas de desocupação</strong>, permitindo que o arrematante obtenha a imissão na posse e a entrega efetiva das chaves de forma extremamente célere logo após a expedição e registro da respectiva Carta de Arrematação.
              </p>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                O condomínio conta com <strong>infraestrutura completa</strong>, incluindo portaria com controle de acesso, interfonia, elevadores e áreas de circulação organizadas, oferecendo segurança e praticidade para moradores e investidores.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-white/10 text-xs">
                <div className="space-y-2">
                  ...
                  <div className="text-gray-300"><strong>Cartório do 11º RGI/RJ:</strong> Matrícula nº 14.273</div>
                  <div className="text-gray-300"><strong>Inscrição Municipal (IPTU):</strong> 0013203-5</div>
                </div>
                <div className="space-y-2">
                  <div className="text-bronze font-bold uppercase tracking-wider">Dados Cadastrais</div>
                  <div className="text-gray-300"><strong>Tipologia:</strong> Apartamento Residencial (Bloco E, Apto 403)</div>
                  <div className="text-gray-300"><strong>Área Privativa:</strong> 57 m² • Estado: Desocupado / Vazio</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-midnight-light/20 rounded-2xl p-8 border border-white/10 space-y-4">
              <h2 className="text-2xl font-serif font-bold text-white flex items-center gap-2">
                <Landmark className="text-bronze" size={24} /> Contexto de Mercado & Potencial de Rentabilidade
              </h2>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                A <strong>Avenida Presidente Vargas</strong> e a região do Rio Comprido / Estácio / Cidade Nova representam um eixo estratégico de mobilidade urbana no Rio de Janeiro. A localização oferece acesso direto e imediato ao Centro da Cidade, Tijuca, Zona Sul (via Túnel Santa Bárbara e Rebouças) e às principais vias expressas (Linha Vermelha e Avenida Brasil), contando ainda com estações de metrô e ampla malha de transporte.
              </p>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                Com lance inicial na 2ª praça fixado em <strong>R$ 171.000,00 (75% da avaliação judicial)</strong> para uma área de 57 m², o valor unitário atinge apenas <strong>R$ 3.000,00/m²</strong>. Trata-se de um custo de aquisição significativamente inferior à média de mercado da região (comercializada habitualmente entre R$ 4.500,00 e R$ 6.000,00/m²), garantindo <strong>alta liquidez para locação residencial a profissionais e estudantes</strong> ou expressiva margem de lucro líquido para revenda após pequenas modernizações estéticas.
              </p>
            </div>
            ...
            <div className="bg-midnight-light/20 rounded-2xl p-8 border border-white/10 space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                A arrematação judicial admite a participação de pessoas físicas e jurídicas, à vista ou por intermédio do regime legal de propostas parceladas previsto no <strong>Artigo 895 do Código de Processo Civil</strong>:
              </p>
              <ul className="space-y-3 text-sm text-gray-300">
                <li className="flex items-start gap-2">
                  <CheckCircle2 size={16} className="text-bronze shrink-0 mt-1" />
                  <span><strong>1ª Praça (14/09/2026 às 12:00h):</strong> Abertura dos lances pelo valor integral da avaliação judicial (R$ 228.000,00).</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 size={16} className="text-emerald-400 shrink-0 mt-1" />
                  <span><strong>2ª Praça (17/09/2026 às 12:00h):</strong> Lances com lance mínimo fixado em 75% da avaliação (R$ 171.000,00 / economia de R$ 57.000,00).</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 size={16} className="text-bronze shrink-0 mt-1" />
                  <span><strong>Regime de Parcelamento Judicial:</strong> O interessado pode protocolar proposta antes do fechamento do leilão com sinal mínimo de 25% à vista e o saldo restante financiado em até 30 parcelas mensais corrigidas por índice oficial da Justiça, com hipoteca judicial averbada na Matrícula nº 14.273 do 11º RGI.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-midnight-light/30 border border-bronze/30 rounded-2xl p-6 space-y-4">
              ...
              <div className="space-y-3 text-xs border-t border-white/10 pt-4">
                ...
                <div>
                  <span className="text-text-muted block">Status de Desocupação:</span>
                  <span className="text-emerald-400 font-medium">Imóvel Vazio / Entrega Rápida</span>
                </div>
              </div>
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20desejo%20solicitar%20a%20auditoria%20jur%C3%ADdica%20do%20leil%C3%A3o%20da%20Av.%20Presidente%20Vargas%203555%20Bloco%20E%20Apto%20403."
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-midnight-light/20 border border-white/10 rounded-2xl p-6 space-y-4">
              ...
              <div className="space-y-3 text-xs text-gray-300">
                ...
                <div className="flex gap-2">
                  ...
                  <span><strong>Imissão na Posse:</strong> Mandado judicial e entrega definitiva das chaves do imóvel vazio.</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-left space-y-6">
          <div className="text-center space-y-2">
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-white">
              Perguntas Frequentes sobre o Leilão na Av. Presidente Vargas 3555
            </h2>
            <p className="text-text-muted text-sm">
              Esclarecimentos técnicos e jurídicos sobre a oportunidade no condomínio residencial.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-br from-midnight-light to-midnight border border-bronze/30 rounded-3xl p-8 sm:p-12 text-center space-y-6 relative overflow-hidden shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-4">
            <h2 className="text-2xl sm:text-4xl font-serif font-bold text-white">
              Arremate Imóveis no Rio de Janeiro com Segurança Jurídica Plena
            </h2>
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              O escritório Soares Martins Advogados oferece assessoria jurídica especializada em leilões judiciais e extrajudiciais de imóveis no Rio de Janeiro. Cuidamos de todo o processo — da análise de riscos processuais e certidões à homologação e entrega das chaves.
            </p>
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20conversar%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20403%20do%20Bloco%20E%20na%20Av.%20Presidente%20Vargas%203555%20no%20Rio%20Comprido%20-%20Rio%20de%20Janeiro."
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="bg-midnight-light border border-bronze/40 rounded-3xl max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl max-h-[90vh] overflow-y-auto text-left">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-gray-300 leading-relaxed">
              <div>
                ...
                Apartamento nº 403 do Bloco E, situado no condomínio na Avenida Presidente Vargas, nº 3555, Rio Comprido / Região Central, Rio de Janeiro/RJ. Área privativa de 57 m², encontrando-se atualmente DESOCUPADO (VAZIO).
              </div>

              <div>
                <strong className="text-white block text-sm mb-1">Características do Condomínio:</strong>
                Conjunto residencial com infraestrutura, portaria com controle de acesso, elevadores e áreas de circulação.
              </div>

              <div>
                <strong className="text-white block text-sm mb-1">Registros e Inscrições:</strong>
                Matrícula nº 14.273 do Cartório do 11º Ofício de Registro de Imóveis (11º RGI/RJ) e Inscrição Municipal (IPTU) nº 0013203-5.
              </div>

              <div>
                <strong className="text-white block text-sm mb-1">Valores e Praças Judiciais:</strong>
                Avaliação judicial homologada: R$ 228.000,00.<br />
                • 1ª Praça: 14/09/2026 às 12:00h — Lance mínimo: R$ 228.000,00 (100% da avaliação).<br />
                • 2ª Praça: 17/09/2026 às 12:00h — Lance mínimo: R$ 171.000,00 (75% da avaliação / 25% de desconto).
              </div>
            ...
            <div className="pt-4 border-t border-white/10 flex gap-3">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20edital%20completo%20do%20leil%C3%A3o%20da%20Av.%20Presidente%20Vargas%203555%20Bloco%20E%20Apto%20403."
                target="_blank"
                rel="noopener noreferrer"
...
export default RioCompridoPresidenteVargas3555AuctionPage;
