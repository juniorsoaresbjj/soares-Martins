...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1787362577764.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface BotafogoPassagem159AuctionPageProps {
  onBack?: () => void;
}

const BotafogoPassagem159AuctionPage: React.FC<BotafogoPassagem159AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['botafogo-rua-da-passagem-159-apto-803'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/botafogo/apartamento/rua-da-passagem-159-apto-803/";
  ...
  return (
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20803%20na%20Rua%20da%20Passagem%20159%20em%20Botafogo."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua da Passagem, nº 159, Apto 803 — Botafogo, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 0053374 do Cartório do 3º Ofício de Registro de Imóveis (3º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0.691.419-6</li>
                <li><strong className="text-white">Área Privativa / Edificada:</strong> 22 metros quadrados (22 m²)</li>
                <li><strong className="text-white">Pavimento e Posição:</strong> 8º Pavimento (Andar Alto), Posição de Frente</li>
                <li><strong className="text-white">Estrutura do Condomínio:</strong> 44 apartamentos (8 andares residenciais e 2 coberturas, 6 por andar), portaria 24h, 2 elevadores, câmeras</li>
                <li><strong className="text-white">Estado de Ocupação:</strong> Unidade fechada há vários anos, sem ocupação conhecida</li>
                <li><strong className="text-white">Bairro / Região:</strong> Botafogo (Zona Sul) — Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 340.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 340.000,00 (21/09/2026 às 11:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (60%):</strong> R$ 204.000,00 (23/09/2026 às 11:00h) — desconto de 40% (R$ 136.000,00 abaixo da avaliação)</li>
        ...
        {/* Contexto de Mercado e Potencial de Locação em Botafogo */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <Store size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado e Rentabilidade de Studios em Botafogo
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Botafogo é o epicentro cultural, corporativo e gastronômico da Zona Sul carioca. Conhecido como polo de inovação e vida noturna cosmopolita, o bairro possui demanda permanente por unidades compactas e studios, impulsionada por jovens profissionais, estudantes universitários, médicos de plantão e turistas.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua da Passagem desfruta de localização privilegiada: a poucos minutos a pé da Estação de Metrô Botafogo, do Botafogo Praia Shopping, de hospitais renomados (Hospital Samaritano, Pró-Cardíaco), supermercados e polos gastronômicos de excelência. Trata-se de uma via estratégica com conectividade direta a Copacabana, Aterro do Flamengo e Centro da Cidade.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Por se tratar de um apartamento de frente, em andar alto (8º andar), com portaria 24 horas e desocupado há anos, o imóvel apresenta facilidade de reforma e rápida colocação em plataformas de locação por temporada (Airbnb) ou locação tradicional, gerando elevado Yield sobre o capital arrematado.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Oportunidade com 40% de Desconto na 2ª Praça (Lance Inicial a R$ 204.000,00)
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação homologada em R$ 340.000,00, a abertura da 2ª praça judicial por R$ 204.000,00 para um studio de frente no 8º andar em Botafogo representa um dos custos de entrada mais acessíveis para investimento imobiliário na Zona Sul do Rio de Janeiro.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                O arrematante pode submeter proposta por escrito para aquisição parcelada: entrada de no mínimo 25% à vista e o saldo restante em até 30 (trinta) parcelas mensais e sucessivas corrigidas, com garantia hipotecária registrada na própria matrícula nº 0053374 do 3º RGI/RJ.
              </p>
            </div>
          </div>
        </article>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria na Matrícula nº 0053374 (3º RGI), certidões fiscais de IPTU nº 0.691.419-6, débitos condominiais e regularidade das citações nos autos do TJRJ.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Acompanhamento da assinatura do Auto de Arrematação, expedição da Carta de Arrematação pelo juiz, guias de ITBI e registro definitivo no 3º RGI.
              </p>
            </div>
        ...
        <article className="bg-gradient-to-br from-midnight-light to-midnight rounded-3xl p-8 sm:p-12 border border-bronze/30 text-center space-y-6 shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Botafogo%20Rua%20da%20Passagem%20159%20Apto%20803"
...
export default BotafogoPassagem159AuctionPage;
