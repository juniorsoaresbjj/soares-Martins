...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1785849884829.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface CopacabanaAtlantica3806AuctionPageProps {
  onBack?: () => void;
}

const CopacabanaAtlantica3806AuctionPage: React.FC<CopacabanaAtlantica3806AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['copacabana-atlantica-3806'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://www.juniorsadvogados.com.br/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/copacabana/apartamento/avenida-atlantica-3806-apto-312/";
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20312%20na%20Avenida%20Atl%C3%A2ntica%203806%20em%20Copacabana."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Avenida Atlântica, nº 3806, Apto 312 — Copacabana, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Entrada Suplementar:</strong> Avenida Nossa Senhora de Copacabana, nº 1241</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 29.681 do Cartório do 5º Ofício de Registro de Imóveis do Rio de Janeiro (5º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0.596.643-7</li>
                <li><strong className="text-white">Área Edificada / Útil:</strong> 27 metros quadrados (27 m²)</li>
                <li><strong className="text-white">Posição do Imóvel:</strong> Fundos</li>
                <li><strong className="text-white">Ano de Construção do Prédio:</strong> 1955 (utilização residencial)</li>
                <li><strong className="text-white">Bairro / Região:</strong> Copacabana (Orla - Posto 5 / Posto 6) — Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 450.100,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 450.100,00 (02/09/2026 às 14:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 225.100,00 (14/09/2026 às 14:00h) — desconto de 50% do valor da avaliação</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Caracterização da Região e Potencial de Investimento na Avenida Atlântica
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Avenida Atlântica é o endereço mais icônico e valorizado de Copacabana, reconhecido internacionalmente por seu calçadão de pedras portuguesas e pela deslumbrante vista do mar da Zona Sul carioca. O edifício no nº 3806 conta com a praticidade da entrada suplementar pela Avenida Nossa Senhora de Copacabana, nº 1241, proporcionando rápido acesso a supermercados, farmácias, restaurantes renomados e estações de metrô (Cantagalo e General Osório).
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Apartamentos compactos de 27 m² localizados na orla marítima apresentam baixíssimo índice de vacância e liquidez imediata para locação por temporada (Airbnb) ou locação residencial tradicional. A posição de fundos garante maior tranquilidade e isolamento acústico em relação ao fluxo do calçadão, mantendo todos os privilégios da localização nobre na orla de Copacabana.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            ...
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação judicial oficial de R$ 450.100,00, a abertura da 2ª praça por R$ 225.100,00 oferece um desconto extraordinário de 50%, permitindo excelente margem de lucratividade patrimonial ou rentabilidade sobre o capital investido na Zona Sul carioca.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Nossa equipe realiza due diligence integral da Matrícula nº 29.681 do Cartório do 5º Ofício de Registro de Imóveis do Rio de Janeiro, levantamento fiscal completo do IPTU nº 0.596.643-7 e análise minuciosa do processo de execução no TJRJ, assegurando que o arrematante receba o imóvel livre de hipotecas, penhoras ou débitos fiscais anteriores, com fulcro no art. 130, parágrafo único, do Código Tributário Nacional.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria jurídica completa da matrícula nº 29.681 (5º RGI/RJ), certidões do executado e certidões fiscais de IPTU.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Habilitação legal perante o leiloeiro oficial e definição do teto estratégico de lance na 1ª ou 2ª Praça.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Assinatura do Auto de Arrematação, recolhimento de custas e emissão das guias judiciais de pagamento.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação, registro no 5º RGI e imissão na posse judicial com rapidez e segurança.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20312%20na%20Avenida%20Atl%C3%A2ntica%203806%20em%20Copacabana."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Avenida%20Atl%C3%A2ntica%203806%20em%20Copacabana."
                target="_blank"
                rel="noopener noreferrer"
...
export default CopacabanaAtlantica3806AuctionPage;
