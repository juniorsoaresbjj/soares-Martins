...
const CopacabanaAtlantica3806AuctionPage: React.FC<CopacabanaAtlantica3806AuctionPageProps> = () => {
  ...
  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/copacabana/apartamento/avenida-atlantica-3806-apto-312/";
