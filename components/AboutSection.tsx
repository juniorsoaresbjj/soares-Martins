      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="space-y-2">
            <span className="text-bronze text-[10px] sm:text-xs font-bold uppercase tracking-widest">{t('about.tag')}</span>
            <h2 className="font-serif text-midnight text-3xl sm:text-4xl md:text-6xl leading-tight">
