...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1789603198544.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface CopacabanaSiqueiraCampos143AuctionPageProps {
  onBack?: () => void;
}

const CopacabanaSiqueiraCampos143AuctionPage: React.FC<CopacabanaSiqueiraCampos143AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['copacabana-siqueira-campos-143-apto-740'];
  const item = (editalEntry && editalEntry[language]) ? editalEntry[language] : (editalEntry ? editalEntry.pt : {
    ...
    val: 'R$ 390.000,00',
    p2Val: 'R$ 195.000,00',
    description: 'Apartamento residencial com 44 m² de área privativa edificada, situado na posição de fundos do 7º pavimento (unidade 740) do tradicional edifício na Rua Siqueira Campos nº 143, em Copacabana, Rio de Janeiro.',
    checklist: [],
    modal: { title: 'Resumo Estruturado do Edital', sections: [] },
    faqs: []
  });

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/copacabana/apartamento/rua-siqueira-campos-143-apto-740/";
    ...
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20740%20na%20Rua%20Siqueira%20Campos%20143%20em%20Copacabana."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Siqueira Campos, nº 143, Apartamento 740 — Copacabana, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Bairro / Região:</strong> Copacabana (entre a Praça Serzedelo Correia, Metrô Siqueira Campos e Praia)</li>
                <li><strong className="text-white">Andar e Posição:</strong> 7º pavimento, unidade 740, posição de fundos</li>
                <li><strong className="text-white">Área Edificada Privativa:</strong> 44 metros quadrados (44 m²)</li>
                <li><strong className="text-white">Fachada e Esquadrias:</strong> Prédio cuja fachada é em argamassa, com janelas em esquadria de madeira</li>
                <li><strong className="text-white">Ano de Construção:</strong> 1970 (edifício consolidado e tradicional no bairro)</li>
                <li><strong className="text-white">Térreo Comercial:</strong> O condomínio possui lojas comerciais no alinhamento da via pública no andar térreo</li>
                <li><strong className="text-white">Elevadores:</strong> Edifício servido por 02 (dois) elevadores com capacidade para 07 pessoas cada</li>
                <li><strong className="text-white">Portaria e Acesso:</strong> Portaria simples, com portão de ferro, paredes em argamassa, piso em marmorite, sem modernização</li>
                <li><strong className="text-white">Garagem:</strong> O imóvel não possui vaga de garagem</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Registrado, dimensionado e caracterizado no Cartório do 5º Ofício de Registro de Imóveis do Rio de Janeiro (5º RGI/RJ) sob a matrícula nº 27773</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 046100-9</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 390.000,00 (homologada nos autos)</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 390.000,00 (05/10/2026 às 14:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 195.000,00 (08/10/2026 às 14:00h) — desconto de R$ 195.000,00</li>
                <li><strong className="text-white">Regra de Redução da 2ª Praça:</strong> Terá início com 50% do valor da avaliação judicial</li>
                <li><strong className="text-white">Modalidades de Pagamento:</strong> Depósito judicial à vista ou parcelamento com garantia hipotecária nos termos do Art. 895 do Código de Processo Civil</li>
              </ul>
            </div>
          </div>
        </article>

        {/* Contexto de Mercado e Potencial de Rentabilidade em Copacabana */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <Store size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado: Rua Siqueira Campos, Liquidez e Deságio por Metro Quadrado
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Siqueira Campos é a principal espinha dorsal comercial e logística de Copacabana, integrando diretamente a Praia de Copacabana (Posto 3 / Posto 4), a Praça Serzedelo Correia, o Shopping Cidade Copacabana (Teatro Tereza Rachel / Net Rio), o Hospital Copa D'Or e a Estação do Metrô Siqueira Campos. É um endereço com vitalidade urbana ininterrupta, onde a conveniência para o dia a dia é insuperável.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Unidades residenciais compactas de 44 m² com posição de fundos gozam de uma vantagem competitiva determinante na Siqueira Campos: desfrutam de toda a proximidade aos serviços, comércio, gastronomia e transporte de massa, resguardando o morador do ruído do tráfego veicular da rua principal. Essa tipologia possui baixíssima taxa de vacância, sendo amplamente disputada tanto para locação tradicional quanto para moradores de longa permanência.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Sob o prisma estritamente financeiro, o patamar da 2ª praça é notável: ao ser arrematado por <strong>R$ 195.000,00</strong> para 44 m² de área privativa, o custo efetivo de aquisição atinge meros <strong>R$ 4.431,81 por metro quadrado</strong>. Em um mercado onde os imóveis residenciais usados em Copacabana são negociados corriqueiramente entre R$ 10.500,00 e R$ 14.000,00/m², o desconto de 50% cria uma blindagem patrimonial com margem de segurança de dezenas de milhares de reais.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> R$ 4.431/m² no Coração Comercial de Copacabana
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com valor inicial de 2ª praça fixado em R$ 195 mil, o apartamento 740 viabiliza retorno financeiro ímpar, seja para moradia acessível na Zona Sul com custo por metro quadrado comparável à Zona Norte, ou para investidores focados em retorno percentual de aluguel (dividend yield) superior à média da capital fluminense.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O leilão será conduzido na modalidade eletrônica (online) por leiloeiro público credenciado pelo Tribunal de Justiça do Rio de Janeiro. A habilitação exige envio prévio de documentos de identificação, comprovante de residência e certidões no portal do leiloeiro oficial com antecedência mínima de 48 horas úteis.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Depósito judicial do lance vencedor vinculado aos autos da execução no TJRJ no prazo assinalado pelo edital, acrescido de 5% de comissão ao leiloeiro e custas cartorárias de homologação.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Apresentação formal de proposta por escrito antes do encerramento da praça: sinal mínimo de 25% à vista (R$ 48.750,00 na 2ª praça) e saldo remanescente parcelado em até 30 meses corrigidos por índice da Justiça estadual, com hipoteca judicial gravada na matrícula nº 27773 do 5º RGI.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Embora a arrematação judicial seja forma originária de aquisição que extingue gravames precedentes, o exame prévio por advogados especialistas é indispensável para verificar a regularidade das intimações no TJRJ, calcular débitos de condomínio com natureza propter rem e garantir a sub-rogação de débitos tributários de IPTU nos termos do art. 130 do CTN.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria registral minuciosa da Matrícula 27773 (5º RGI/RJ), certidões do executado e regularidade fiscal do IPTU nº 046100-9.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Credenciamento formal perante o leiloeiro oficial, estruturação da proposta pelo Art. 895 do CPC e cálculo do teto de lance seguro.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Assinatura do auto de arrematação, apuração e emissão do ITBI junto à Prefeitura do Rio e cancelamento de ônus no 5º RGI.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação no TJRJ e requerimento imediato do Mandado de Imissão na Posse com oficial de justiça.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20740%20na%20Rua%20Siqueira%20Campos%20143%20em%20Copacabana."
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Copacabana%20Rua%20Siqueira%20Campos%20143%20Apto%20740" 
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Rua%20Siqueira%20Campos%20143%20em%20Copacabana."
                target="_blank"
                rel="noopener noreferrer"
...
export default CopacabanaSiqueiraCampos143AuctionPage;
