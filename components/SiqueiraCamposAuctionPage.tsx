...
interface SiqueiraCamposAuctionPageProps {
  onBack?: () => void;
}

const SiqueiraCamposAuctionPage: React.FC<SiqueiraCamposAuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['copacabana-siqueira-campos'] || editaisData['copacabana-viveiros'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/copacabana/apartamento/rua-siqueira-campos-43/";
  ...
  return (
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href={`https://wa.me/5521979549241?text=${encodeURIComponent(
                      language === 'es' ? 'Hola, quisiera información sobre la subasta de Copacabana en Calle Siqueira Campos 43 apto 1123.' :
                      language === 'en' ? 'Hello, I would like information about the Copacabana auction on Siqueira Campos St 43 apt 1123.' :
                      'Olá, gostaria de informações sobre o leilão de Copacabana na Rua Siqueira Campos 43 apto 1123.'
                    )}`}
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço:</strong> Rua Siqueira Campos, nº 43, Apto. 1123 — Copacabana, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Edifício:</strong> Condomínio do Edifício Centro Comercial de Copacabana</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 5098 do 5º Ofício de Registro de Imóveis do Rio de Janeiro (5º RGI)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0.686.319-5</li>
                <li><strong className="text-white">Área Edificada:</strong> 38m²</li>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              <h3 className="text-bronze font-serif font-bold text-base flex items-center gap-2">
                <Landmark size={18} /> Dados da Execução e Avaliação
              </h3>
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Juízo Executante:</strong> 5ª Vara Cível da Comarca da Capital / TJRJ</li>
        ...
        {/* Contexto de Mercado e Oportunidade de Investimento */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <ShieldCheck size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado em Copacabana e Análise Econômica
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Siqueira Campos é uma das vias mais icônicas e movimentadas do bairro de Copacabana, concentrando ampla rede de comércio, serviços, bancos e acesso direto à Estação de Metrô Siqueira Campos e à famosa Praia de Copacabana.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O apartamento de 38m² com posição de frente no Condomínio do Edifício Centro Comercial de Copacabana apresenta excelente planta compacta com cômodos integrados e dormitório separado. Unidades nessa metragem na Zona Sul do Rio de Janeiro possuem elevadíssima liquidez, sendo altamente procuradas tanto para moradia quanto para locação residencial fixa ou por temporada (Airbnb).
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base">
              Margem de Deságio na 2ª Praça Judicial
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação oficial de R$ 400.000,00 e lance inicial na 2ª praça fixado em R$ 200.000,00 (50% de desconto), o arrematante adquire o imóvel por um valor significativamente inferior ao preço de mercado praticado na região de Copacabana, garantindo expressiva margem de segurança e retorno financeiro.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Arrematar um imóvel em leilão judicial exige análise rigorosa do edital, das certidões dos distribuidores cíveis e fiscais, do saldo devedor condominial e de eventuais recursos pendentes no TJRJ. Nosso escritório atua preventivamente para neutralizar riscos e garantir a expedição célere da carta de arrematação e imissão na posse.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria minuciosa do processo, da matrícula nº 5098 do 5º RGI, dívidas de IPTU e débitos condominiais.
              </p>
            </div>

            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              <div className="text-bronze font-bold text-sm flex items-center gap-1.5">
                <CheckCircle2 size={16} /> 2. Habilitação e Lances
              </div>
              <p className="text-xs text-text-muted">
                Cadastro e habilitação do arrematante na plataforma do leiloeiro com estratégia tática de lances.
              </p>
            </div>

            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              <div className="text-bronze font-bold text-sm flex items-center gap-1.5">
                <CheckCircle2 size={16} /> 3. Homologação Judicial
              </div>
              <p className="text-xs text-text-muted">
                Assinatura do auto de arrematação, recolhimento de ITBI e custas para expedição da Carta de Arrematação.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Atuação no cumprimento do mandado judicial de imissão na posse para entrega das chaves ao arrematante.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href={`https://wa.me/5521979549241?text=${encodeURIComponent(
                  language === 'es' ? 'Hola, quisiera asesoría jurídica para la subasta de Copacabana en Calle Siqueira Campos.' :
                  language === 'en' ? 'Hello, I would like legal advice for the Copacabana auction on Siqueira Campos St.' :
                  'Olá, gostaria de informações sobre a assessoria jurídica para o leilão de Copacabana na Rua Siqueira Campos.'
                )}`}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href={`https://wa.me/5521979549241?text=${encodeURIComponent(
                  language === 'es' ? 'Hola, quisiera solicitar el parecer completo sobre el edicto de Copacabana Siqueira Campos.' :
                  language === 'en' ? 'Hello, I would like to request the full legal audit report for the Copacabana Siqueira Campos auction.' :
                  'Olá, gostaria de solicitar o parecer completo do edital de Copacabana na Rua Siqueira Campos.'
                )}`}
                target="_blank"
                rel="noopener noreferrer"
...
export default SiqueiraCamposAuctionPage;
