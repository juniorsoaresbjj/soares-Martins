...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1786461014988.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface CopacabanaSilvaCastro44AuctionPageProps {
  onBack?: () => void;
}

const CopacabanaSilvaCastro44AuctionPage: React.FC<CopacabanaSilvaCastro44AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['copacabana-silva-castro-44'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/copacabana/cobertura/rua-silva-castro-44-apto-1001/";
  ...
  return (
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 pb-12 sm:pb-16">
        <div className="bg-midnight-light/40 backdrop-blur-sm rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-bronze/10 border border-bronze/30 text-bronze text-xs font-semibold uppercase tracking-wider mb-6">
            <Gavel size={14} /> Cobertura Duplex • Copacabana/RJ
          </div>
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20da%20cobertura%20na%20Rua%20Silva%20Castro%2044%20em%20Copacabana."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Silva Castro, nº 44, Apto 1001 (Cobertura) — Copacabana, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 107.466 do Cartório do 5º Ofício de Registro de Imóveis do Rio de Janeiro (5º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0.065.088-7</li>
                <li><strong className="text-white">Área Edificada Total:</strong> 206 metros quadrados (206 m²)</li>
                <li><strong className="text-white">Distribuição Interna:</strong> Imóvel de frente, 3 quartos (1 suíte), 2 banheiros sociais + banheiro da suíte, 2 salas (uma em cada pavimento), cozinha, área de serviço e dependência completa de empregada.</li>
                <li><strong className="text-white">1º Pavimento:</strong> Ampla sala de frente com piso em porcelanato e parede com textura cinza, janelas de esquadria de alumínio, 2 quartos de frente para a Rua Silva Castro, 1 suíte nos fundos, hall em porcelanato, banheiros e cozinha com revestimentos cerâmicos.</li>
                <li><strong className="text-white">2º Pavimento:</strong> Escada em alvenaria revestida de madeira, sala em porcelanato, banheiro em ladrilho e azulejos amarelos, área privativa exclusiva do condomínio de ~22 m² com churrasqueira, terraço em ardósia com canteiro em pastilhas, deck de madeira e piscina redonda de fibra.</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 2.500.000,00 (14/09/2026 às 12:20h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (60%):</strong> R$ 1.500.000,00 (17/09/2026 às 12:20h) — Desconto de 40% sobre a avaliação judicial</li>
        ...
        {/* Contexto de Mercado e Atratividade do Imóvel */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <ShieldCheck size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado e Atratividade em Copacabana (Zona Sul/RJ)
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Silva Castro é uma rua bucólica e estritamente residencial no coração de Copacabana, localizada próxima ao Bairro Peixoto e a poucos minutos da estação de metrô Siqueira Campos e da Praia de Copacabana. Trata-se de uma das áreas mais tranquilas e valorizadas do bairro, aliando privacidade à conveniência de farta rede de serviços, comércio, gastronomia e transporte público.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Com 206 m² de área privativa, planta duplex bem distribuída, churrasqueira privativa, terraço ensolarado com deck e piscina própria, esta cobertura atende a demandas de alto padrão na Zona Sul, apresentando liquidez expressiva tanto para moradia familiar exclusiva quanto para investimento e valorização patrimonial.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base">
              Oportunidade na 2ª Praça: Aquisição por R$ 1.500.000,00 (60% do Valor de Avaliação)
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Arrematar uma cobertura duplex de 206 m² com piscina e churrasqueira em Copacabana por R$ 1.500.000,00 resulta em um custo de apenas ~R$ 7.281/m², valor imbatível para a Zona Sul do Rio de Janeiro, proporcionando margem de lucro e segurança patrimonial atípicas no mercado imobiliário tradicional.
            </p>
          </div>
        </article>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Cadastramento e homologação de documentos na plataforma do leiloeiro oficial credenciado perante o TJRJ com antecedência de 24h a 48h da data da praça.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Lances na 1ª praça (14/09/2026 às 12:20h) ou 2ª praça (17/09/2026 às 12:20h). Alternativamente, protocolização de proposta de parcelamento (Art. 895 do CPC - 25% de entrada + 30 parcelas).
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Assinatura do auto de arrematação, pagamento das guias judiciais e ITBI, expedição da Carta de Arrematação para registro no 5º RGI e imissão liminar na posse.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Arrematar uma cobertura duplex de grande porte exige auditoria jurídica completa da Matrícula nº 107.466 (5º RGI/RJ), verificação de usucapião/direito de uso da área comum de 22 m², análise da regularidade das intimações no processo de execução e avaliação de passivos fiscais ou condominiais.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Análise minuciosa da matrícula, certidões fiscais, convenção do condomínio e autos judiciais.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Parecer de viabilidade econômica e jurídica para lances ao vivo ou proposta parcelada.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Supervisão de depósitos judiciais, desembaraço tributário e expedição da Carta de Arrematação.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                Registro definitivo no 5º RGI/RJ e imissão do arrematante na posse da cobertura.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20da%20cobertura%20na%20Rua%20Silva%20Castro%2044%20em%20Copacabana."
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-text-muted leading-relaxed">
              ...
              <div className="p-4 bg-midnight rounded-xl border border-white/5 space-y-1">
                ...
                <div>Matrícula nº 107.466 do 5º RGI/RJ • IPTU nº 0.065.088-7</div>
              </div>
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20cobertura%20na%20Rua%20Silva%20Castro%2044."
                target="_blank"
                rel="noopener noreferrer"
...
export default CopacabanaSilvaCastro44AuctionPage;
