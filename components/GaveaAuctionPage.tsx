...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1785341638695.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface GaveaAuctionPageProps {
  onBack?: () => void;
}

const GaveaAuctionPage: React.FC<GaveaAuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['gavea-rubens-berardo'] || editaisData['copacabana-siqueira-campos'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/gavea/apartamento/rua-vice-governador-rubens-berardo-175/";
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href={`https://wa.me/5521979549241?text=${encodeURIComponent(
                      language === 'es' ? 'Hola, quisiera información sobre la subasta de Gávea en Calle Vice Governador Rubens Berardo 175 apto 506.' :
                      language === 'en' ? 'Hello, I would like information about the Gávea auction on Vice Governador Rubens Berardo St 175 apt 506.' :
                      'Olá, gostaria de informações sobre o leilão da Gávea na Rua Vice Governador Rubens Berardo 175 apto 506.'
                    )}`}
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço:</strong> Rua Vice Governador Rubens Berardo, nº 175, Apto 506, Bloco III (Acesso suplementar pela Av. Padre Leonel Franca, nº 210) — Gávea, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 31.349 do Cartório do 2º Ofício de Registro de Imóveis do Rio de Janeiro (2º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1.479.851-6</li>
                <li><strong className="text-white">Área Edificada:</strong> 84 m²</li>
                <li><strong className="text-white">Distribuição Interna:</strong> 2 quartos (sendo 1 suíte), banheiro social, sala ampla, cozinha, dependência completa de empregada</li>
                <li><strong className="text-white">Vagas de Garagem:</strong> 2 vagas garantidas na convenção condominial</li>
                <li><strong className="text-white">Bairro:</strong> Gávea — Zona Sul do Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 1.686.801,06</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 1.686.801,06 (14/09/2026 às 11:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 843.401,00 (24/09/2026 às 11:00h)</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Caracterização da Região e Potencial de Investimento na Gávea
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Gávea é reconhecida como um dos bairros de maior prestígio e qualidade de vida da Zona Sul carioca. Vizinha ao Leblon, Jardim Botânico, São Conrado e Lagoa Rodrigo de Freitas, a região combina atmosfera bucólica, ampla cobertura vegetal e um polo cultural e educacional vibrante, ancorado pela Pontifícia Universidade Católica do Rio de Janeiro (PUC-Rio), a Escola Americana, o Parque da Cidade e a Praça Santos Dumont (Polo Gastronômico da Gávea).
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O imóvel localizado na Rua Vice Governador Rubens Berardo 175 beneficia-se da dupla acessibilidade também pela Av. Padre Leonel Franca, oferecendo fácil escoamento para o Túnel Zuzu Angel, Autoestrada Lagoa-Barra e ao metrô da Estação Antero de Quental no Leblon. Apartamentos de 84 m² com 2 quartos e 2 vagas de garagem possuem demanda altíssima para locação residencial familiar e acadêmica, com valores por metro quadrado consolidados no topo do mercado imobiliário do Rio de Janeiro.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            ...
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação oficial fixada em R$ 1.686.801,06, a abertura da 2ª Praça a partir de R$ 843.401,00 (desconto de 50%) representa uma das oportunidades mais expressivas de aquisição imobiliária na Gávea, permitindo expressiva margem de segurança e rentabilidade de capital.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Nossa equipe realiza due diligence minuciosa sobre a Matrícula nº 31.349 do 2º RGI, débitos fiscais junto ao IPTU (1.479.851-6), dívidas condominiais acumuladas e análise do processo de execução no TJRJ, assegurando blindagem patrimonial antes e após a arrematação.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria jurídica completa na matrícula, débitos tributários e ônus do imóvel na Gávea.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Habilitação na plataforma do leiloeiro e planejamento do teto financeiro na 2ª praça.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Assinatura do auto de arrematação, guia de depósito judicial e recolhimento de ITBI.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação, registro no 2º RGI e imissão efetiva na posse das chaves.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href={`https://wa.me/5521979549241?text=${encodeURIComponent(
                  language === 'es' ? 'Hola, quisiera asesoría jurídica para la subasta de Gávea en Calle Vice Governador Rubens Berardo.' :
                  language === 'en' ? 'Hello, I would like legal advice for the Gávea auction on Vice Governador Rubens Berardo St.' :
                  'Olá, gostaria de informações sobre a assessoria jurídica para o leilão da Gávea na Rua Vice Governador Rubens Berardo.'
                )}`}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href={`https://wa.me/5521979549241?text=${encodeURIComponent(
                  language === 'es' ? 'Hola, quisiera solicitar el parecer completo sobre el edicto de Gávea Rubens Berardo.' :
                  language === 'en' ? 'Hello, I would like to request the full legal audit report for the Gávea Rubens Berardo auction.' :
                  'Olá, gostaria de solicitar o parecer completo do edital da Gávea na Rua Vice Governador Rubens Berardo.'
                )}`}
                target="_blank"
                rel="noopener noreferrer"
...
export default GaveaAuctionPage;
