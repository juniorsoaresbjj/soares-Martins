...
interface SantaTeresaCostaBastos8AuctionPageProps {
  onBack?: () => void;
}

const SantaTeresaCostaBastos8AuctionPage: React.FC<SantaTeresaCostaBastos8AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['santa-teresa-costa-bastos'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://www.juniorsadvogados.com.br/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/santa-teresa/apartamento/rua-costa-bastos-8/";
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%201001%20na%20Rua%20Costa%20Bastos%208%20em%20Santa%20Teresa."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço:</strong> Rua Costa Bastos, nº 8, Apto 1001 — Santa Teresa, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 97.791 do Cartório do 2º Ofício de Registro de Imóveis da cidade do Rio de Janeiro (2º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> Sob consulta na certidão fiscal da Prefeitura do Rio de Janeiro</li>
                <li><strong className="text-white">Área Útil:</strong> 51 metros quadrados (51 m²)</li>
                <li><strong className="text-white">Posição e Insolação:</strong> Apartamento de frente para a rua, excelente exposição ao sol da manhã</li>
                <li><strong className="text-white">Distribuição Interna:</strong> Composto de quarto, sala, cozinha e banheiro (provavelmente em estado de conservação)</li>
                <li><strong className="text-white">Edificação:</strong> Prédio antigo e tradicional, com serviço de portaria e sem área de lazer (sem vaga de garagem)</li>
                <li><strong className="text-white">Bairro:</strong> Santa Teresa — Centro/Zona Sul do Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 290.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 290.000,00 (13/08/2026 às 12:20h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 145.000,00 (18/08/2026 às 12:20h) — desconto de 50% do valor da avaliação</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Caracterização da Região e Potencial de Investimento em Santa Teresa
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Santa Teresa é um dos bairros mais singulares, artísticos e charmosos do Rio de Janeiro. Localizado em ponto estratégico que conecta o Centro Cultural da cidade aos bairros da Zona Sul (Glória, Catete, Flamengo e Laranjeiras), o bairro é famoso por sua arquitetura histórica, casarões preservados, circuito gastronômico de alta qualidade e mirantes deslumbrantes.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Um apartamento de 51 m² com sol da manhã e posição de frente na Rua Costa Bastos possui altíssima liquidez tanto para moradia tradicional quanto para locação residencial e de temporada (Airbnb/Booking), atraindo turistas brasileiros e estrangeiros, artistas, acadêmicos e profissionais liberais. A ausência de área de lazer no edifício contribui para uma cota condominial enxuta, otimizando o retorno sobre o investimento (ROI).
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base">
              Oportunidade Única de Arrematação por 50% do Valor de Avaliação
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação oficial de R$ 290.000,00, a abertura da 2ª Praça por R$ 145.000,00 representa um excelente ponto de entrada para aquisição de imóvel próprio ou para formação de patrimônio com margem de valorização imediata pós-desembaraço registral.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Nossa equipe realiza due diligence integral da Matrícula nº 97.791 do Cartório do 2º Ofício de Registro de Imóveis do Rio de Janeiro, verificação das certidões fiscais (IPTU) e análise detalhada dos autos processuais no TJRJ, assegurando que o arrematante não responda por penhoras ou dívidas anteriores à arrematação, com plena sub-rogação dos débitos tributários no preço pago (art. 130, parágrafo único, do CTN).
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria jurídica completa da matrícula nº 97.791 (2º RGI/RJ), ônus processuais e certidões fiscais em Santa Teresa.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Habilitação segura perante o leiloeiro oficial e planejamento financeiro para disputa em 1ª ou 2ª Praça.
              </p>
            </div>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20em%20Santa%20Teresa%20Rua%20Costa%20Bastos."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20de%20Santa%20Teresa%20Rua%20Costa%20Bastos."
                target="_blank"
                rel="noopener noreferrer"
...
export default SantaTeresaCostaBastos8AuctionPage;
