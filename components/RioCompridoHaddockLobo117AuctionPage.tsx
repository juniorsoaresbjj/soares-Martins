...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1785961670376.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface RioCompridoHaddockLobo117AuctionPageProps {
  onBack?: () => void;
}

const RioCompridoHaddockLobo117AuctionPage: React.FC<RioCompridoHaddockLobo117AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['rio-comprido-haddock-lobo-117'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/rio-comprido/apartamento/rua-haddock-lobo-117-apto-301/";
      ...
      <section className="max-w-7xl mx-auto px-6 pb-12 sm:pb-16">
        <div className="bg-midnight-light/40 backdrop-blur-sm rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-bronze/10 border border-bronze/30 text-bronze text-xs font-semibold uppercase tracking-wider mb-6">
            <Gavel size={14} /> Residencial • Rio Comprido/RJ
          </div>
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20Haddock%20Lobo%20117%20Apto%20301."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Haddock Lobo, nº 117, Apartamento 301 — Rio Comprido, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 86.727 do Cartório do 11º Ofício de Registro de Imóveis do Rio de Janeiro (11º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0.699.815-7</li>
                <li><strong className="text-white">Área Edificada:</strong> 74 metros quadrados (74 m²)</li>
                <li><strong className="text-white">Distribuição Interna:</strong> 3 quartos, sala, banheiro social, cozinha e área de serviço</li>
                <li><strong className="text-white">Posição:</strong> 3º andar, de frente para a Rua Haddock Lobo</li>
                <li><strong className="text-white">Infraestrutura do Edifício:</strong> Prédio de 10 andares, portaria reformada com serviço ativo até 22h, elevadores, salão de festas e circuito de câmeras de segurança na entrada</li>
                <li><strong className="text-white">Vaga de Garagem:</strong> Sem vaga de garagem</li>
                <li><strong className="text-white">Mobilidade & Entorno:</strong> Próximo à estação de metrô Afonso Pena, farto comércio do bairro e diversas linhas de ônibus na porta</li>
                <li><strong className="text-white">Bairro / Região:</strong> Rio Comprido (Divisa Tijuca / Centro) — Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 517.827,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 517.827,00 (20/08/2026 às 14:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 258.913,50 (27/08/2026 às 14:00h) — desconto de 50% do valor avaliado</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Caracterização da Região e Potencial de Investimento na Rua Haddock Lobo
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Haddock Lobo é um dos corredores viários e comerciais mais estratégicos da Região Central e Zona Norte do Rio de Janeiro, interligando o bairro do Rio Comprido à Tijuca, Praça da Bandeira e acesso direto ao Centro e à Zona Sul. Com ampla oferta de transporte público, linhas de ônibus frequentes e facilidade de acesso ao Metrô da Praça Afonso Pena, a localização se destaca por sua praticidade urbana incomparável.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O apartamento de 74 m² no 3º andar de frente oferece planta funcional com 3 quartos, ideal para famílias ou para investidores em busca de renda recorrente de locação residencial. O condomínio conta com portaria reformada com atendimento presencial até 22h, elevadores, salão de festas e sistema de segurança com câmeras digitais na entrada, proporcionando tranquilidade e baixo custo de manutenção condominial.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base">
              Oportunidade de Entrada com 50% de Desconto na 2ª Praça
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação oficial de R$ 517.827,00, a abertura da 2ª praça judicial pelo valor mínimo de R$ 258.913,50 representa uma taxa de oportunidade única de apenas ~R$ 3.498/m², patamar extraordinariamente competitivo para um imóvel de 3 quartos bem localizado no Rio de Janeiro.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A arrematação judicial de imóveis exige rigorosa due diligence imobiliária prévia. Nossa equipe realiza a auditoria minuciosa da Matrícula nº 86.727 (11º RGI/RJ), levantamento de débitos fiscais sob o IPTU nº 0.699.815-7, verificação de dívidas condominiais e análise da regularidade das citações no processo judicial do TJRJ, garantindo que o arrematante adquira o bem livre de ônus imprevistos e assegurando a sub-rogação dos débitos tributários sobre o preço da arrematação (art. 130 do CTN).
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria completa da Matrícula nº 86.727 (11º RGI/RJ), certidões de IPTU e passivos processuais no TJRJ.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Habilitação legal no leilão judicial e assessoria no estabelecimento do teto financeiro na 1ª ou 2ª Praça.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Acompanhamento da assinatura do Auto de Arrematação e recolhimento das guias judiciais e comissão.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação, registro no 11º RGI e imissão celeremente concedida na posse.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20na%20Rua%20Haddock%20Lobo%20117%20Apto%20301."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Rua%20Haddock%20Lobo%20117%20Apto%20301."
                target="_blank"
                rel="noopener noreferrer"
...
export default RioCompridoHaddockLobo117AuctionPage;
