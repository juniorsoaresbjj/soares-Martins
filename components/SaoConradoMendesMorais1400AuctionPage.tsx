...
import { 
  ...
  ShieldCheck, FileCheck, Landmark, CheckCircle2, Scale, Store, Sparkles, Waves, Dumbbell
} from 'lucide-react';
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1788438688014.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface SaoConradoMendesMorais1400AuctionPageProps {
  onBack?: () => void;
}

const SaoConradoMendesMorais1400AuctionPage: React.FC<SaoConradoMendesMorais1400AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['sao-conrado-mendes-morais-1400-apto-503'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/sao-conrado/apartamento/avenida-prefeito-mendes-de-morais-1400-bloco-2-apto-503/";
    ...
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20503%20do%20Bloco%202%20no%20Condom%C3%ADnio%20Praia%20Guinle%20(Av.%20Prefeito%20Mendes%20de%20Morais%201400)%20em%20S%C3%A3o%20Conrado."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              <h3 className="text-bronze font-serif font-bold text-base flex items-center gap-2">
                <FileCheck size={18} /> Identificação Imobiliária e Estrutura Predial
              </h3>
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Avenida Prefeito Mendes de Morais, nº 1400, Bloco 2, Apto 503 — São Conrado, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Empreendimento:</strong> Condomínio Praia Guinle (condomínio de altíssimo padrão em frente ao mar)</li>
                <li><strong className="text-white">Área Edificada Privativa:</strong> 268,84 metros quadrados (268,84 m²)</li>
                <li><strong className="text-white">Vagas de Garagem:</strong> 3 (três) vagas de garagem no condomínio vinculadas à unidade</li>
                <li><strong className="text-white">Infraestrutura Condominial:</strong> Portaria e vigilância 24 horas, elevadores modernos, piscina adulto e infantil, academia completa, quadra esportiva, sauna, salão de festas decorado e playground</li>
                <li><strong className="text-white">Localização Exclusiva:</strong> Orla da Praia de São Conrado, com vista para a orla atlântica e para o Maciço da Pedra da Gávea</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 46126 do Cartório do 2º Ofício de Registro de Imóveis do Rio de Janeiro</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1.730.497-3</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 5.221.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 5.221.000,00 (22/09/2026 às 13:20h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 2.610.500,00 (29/09/2026 às 13:20h) — desconto de R$ 2.610.500,00</li>
                <li><strong className="text-white">Economia na 2ª Praça:</strong> 50% de deságio sobre a valoração oficial da Justiça</li>
                <li><strong className="text-white">Condições de Pagamento:</strong> Arrematação à vista ou mediante proposta de parcelamento judicial (Art. 895 do CPC: 25% de entrada e até 30 meses)</li>
              </ul>
            </div>
          </div>
        </article>

        {/* Contexto de Mercado e Exclusividade em São Conrado */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <Store size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado: Praia Guinle, Frente Mar e Valorização em São Conrado
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Avenida Prefeito Mendes de Morais constitui o endereço residencial mais nobre e desejado de São Conrado. Banhada pelas águas do Atlântico e emoldurada pela imponente Pedra da Gávea e pela Pedra Bonita, a orla de São Conrado é sinônimo de privacidade, tranquilidade e estilo de vida exclusivo na Zona Sul carioca, a minutos dos prestigiados Gávea Golf and Country Club e Shopping Fashion Mall.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O <strong>Condomínio Praia Guinle</strong> é um dos edifícios ícones da praia, reconhecido pelo recuo generoso em relação à via pública, segurança privativa armada e uma das áreas de lazer mais completas da orla, incluindo piscinas, academia, sauna, quadra poliesportiva e amplos jardins tropicais. Apartamentos com mais de 260 m² e 3 vagas de garagem são tradicionalmente negociados no mercado de alto padrão por valores sensivelmente superiores a R$ 20.000,00 o metro quadrado.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Na 2ª Praça deste leilão judicial, com o lance mínimo fixado em <strong>R$ 2.610.500,00</strong>, o valor por metro quadrado privativo situa-se em aproximadamente <strong>R$ 9.710,00/m²</strong> — um patamar de preço absolutamente inacessível no mercado tradicional de frente para o mar na Zona Sul, gerando uma margem de proteção patrimonial extraordinária tanto para moradia quanto para investidores.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Economia Bruta de R$ 2.610.500,00 na 2ª Praça
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              O deságio de 50% em relação à avaliação oficial do TJRJ permite ao arrematante absorver com tranquilidade eventuais custos de modernização e taxas de transmissão (ITBI e cartório), consolidando um retorno imediato sobre o capital alocado.
            </p>
          </div>
        </article>

        {/* Como Participar e Estruturação de Propostas */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O leilão judicial será realizado de forma eletrônica por leiloeiro oficial credenciado perante o Tribunal de Justiça do Estado do Rio de Janeiro. Para participar, os interessados devem providenciar o cadastro prévio e a homologação de seus documentos perante a plataforma do leiloeiro com antecedência mínima recomendada de 48 horas.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Depósito judicial do montante integral do lance vencedor em conta judicial vinculada ao processo no TJRJ, acrescido de 5% de comissão do leiloeiro e custas cartorárias para expedição da Carta de Arrematação e ordens de cancelamento de penhoras.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                É facultado ao arrematante apresentar proposta escrita antes do leilão ofertando no mínimo 25% de entrada à vista e o saldo restante em até 30 (trinta) parcelas mensais corrigidas por índice judicial oficial, garantidas por hipoteca sobre a Matrícula nº 46126 do 2º RGI.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A arrematação de imóveis de alto padrão na orla carioca demanda rigorosa análise jurídica processual e registral para evitar surpresas com passivos de condomínio, verificar a eficácia de intimações e viabilizar a transferência rápida da propriedade sem riscos de anulação.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria na Matrícula nº 46126 (2º RGI), certidões fiscais do IPTU nº 1.730.497-3, verificação de quotas de condomínio no Praia Guinle e análise de nulidades no edital.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Planejamento de lances para 1ª ou 2ª praça, redação técnica de propostas de parcelamento judicial (Art. 895 do CPC) e suporte durante o pregão eletrônico.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Acompanhamento da homologação judicial do auto de arrematação, apuração e guia de ITBI, expedição da Carta de Arrematação e mandados de cancelamento de penhoras.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Atuação judicial para cumprimento expedito do mandado de imissão de posse com Oficial de Justiça e entrega imediata das chaves do apartamento ao arrematante.
              </p>
            </div>
          </div>
        </article>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-xs text-text-muted leading-relaxed">
                  Entenda o passo a passo da arrematação, editais, 1ª e 2ª praça, riscos jurídicos e cancelamento de gravames.
                </p>
              </div>
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-xs text-text-muted leading-relaxed">
                  Como funciona a penhora da unidade por débitos propter rem, sub-rogação no preço e jurisprudência do STJ.
                </p>
              </div>
              <div className="mt-4 text-xs text-bronze font-bold flex items-center gap-1 group-hover:translate-x-1 transition-transform">
                Ler artigo <ChevronRight size={14} />
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-xs text-text-muted leading-relaxed">
                  A importância da análise minuciosa de certidões cíveis, fiscais e trabalhistas para blindar o investidor imobiliário.
                </p>
              </div>
              <div className="mt-4 text-xs text-bronze font-bold flex items-center gap-1 group-hover:translate-x-1 transition-transform">
                Ler artigo <ChevronRight size={14} />
        ...
        {/* FAQ Específica do Apartamento em São Conrado */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
        ...
        <article className="bg-gradient-to-br from-midnight-light to-midnight rounded-3xl p-8 sm:p-12 border border-bronze/30 text-center space-y-6 shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Sao%20Conrado%20Av%20Prefeito%20Mendes%20de%20Morais%201400%20Apto%20503"
...
export default SaoConradoMendesMorais1400AuctionPage;
