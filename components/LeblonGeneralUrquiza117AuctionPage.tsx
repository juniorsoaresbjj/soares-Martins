...
import { 
  ...
  ShieldCheck, FileCheck, Landmark, CheckCircle2, Scale, Sparkles, Waves
} from 'lucide-react';
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1789391154716.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface LeblonGeneralUrquiza117AuctionPageProps {
  onBack?: () => void;
}

const LeblonGeneralUrquiza117AuctionPage: React.FC<LeblonGeneralUrquiza117AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['leblon-general-urquiza-117-apto-501'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/leblon/apartamento/rua-general-urquiza-117-apto-501/";
    ...
    <div className="min-h-screen bg-midnight text-white text-left font-sans">
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20501%20na%20Rua%20General%20Urquiza%20117%20no%20Leblon."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Completo:</strong> Rua General Urquiza, nº 117, Apartamento 501 — Leblon, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Bairro e Região:</strong> Leblon — Zona Sul do Rio de Janeiro</li>
                <li><strong className="text-white">Andar e Posição:</strong> 5º pavimento, Apartamento 501</li>
                <li><strong className="text-white">Área Privativa Edificada:</strong> 75 metros quadrados (75 m²)</li>
                <li><strong className="text-white">Condomínio:</strong> Condomínio do Edifício 24 de Outubro</li>
                <li><strong className="text-white">Data de Construção:</strong> 1953</li>
                <li><strong className="text-white">Divisão Interna:</strong> Sala ampla em dois ambientes (piso cerâmico), dois quartos (piso de taco de madeira), um banheiro social (piso e paredes revestidos em cerâmica), cozinha, área de serviço e banheiro de serviço</li>
                <li><strong className="text-white">Vaga de Garagem:</strong> O imóvel NÃO possui vaga de garagem</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Devidamente registrado, dimensionado e caracterizado no 2º Ofício de Registro de Imóveis do Rio de Janeiro (2º RGI/RJ) sob a matrícula nº 995653</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0642600-1</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 1.449.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 1.449.000,00 (28/09/2026 às 12:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 724.500,00 (01/10/2026 às 12:00h) — desconto de 50% (economia de R$ 724.500,00)</li>
                <li><strong className="text-white">Regra da 2ª Praça:</strong> Terá como início 50% do valor da avaliação judicial homologada</li>
                <li><strong className="text-white">Condições de Pagamento:</strong> À vista mediante guia de depósito judicial no TJRJ ou proposta formal de parcelamento judicial nos moldes do Art. 895 do CPC (sinal mínimo de 25% e saldo em até 30 meses corrigidos com garantia hipotecária)</li>
              </ul>
            </div>
          </div>
        </article>

        {/* Contexto de Mercado e Oportunidade no Leblon */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            <Waves size={24} className="shrink-0" />
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado: Leblon, o Endereço Mais Valorizado do Brasil
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O Leblon ostenta há décadas a liderança absoluta no índice de valorização imobiliária do Brasil e da América Latina. Sua atmosfera cosmopolita, ruas arborizadas, segurança reforçada e gastronomia de nível internacional atraem famílias tradicionais, executivos e investidores que priorizam liquidez patrimonial perene e qualidade de vida inigualável.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua General Urquiza é uma das vias residenciais mais cobiçadas e valorizadas do Leblon. Localizada a passos da Praça Antero de Quental (com estação de metrô de alta conectividade), do polo gastronômico da Rua Dias Ferreira e a poucas quadras da Praia do Leblon e do Posto 12, o endereço proporciona uma rotina a pé completa e sofisticada, com os melhores restaurantes, empórios e serviços da Zona Sul.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            No mercado secundário tradicional do Leblon, o metro quadrado de apartamentos residenciais de 2 quartos varia habitualmente entre <strong>R$ 22.000/m² e R$ 35.000/m²</strong>, superando frequentemente esse patamar após reformas completas. Neste certame judicial, a abertura da 2ª praça a <strong>R$ 724.500,00</strong> viabiliza a arrematação desta unidade de 75 m² por apenas <strong>R$ 9.660 por metro quadrado</strong>. Trata-se de uma margem de proteção patrimonial extraordinária e raramente disponível no mercado fechado da Zona Sul.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Planta Versátil de 75 m² no Edifício 24 de Outubro (1953)
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              O Edifício 24 de Outubro foi edificado em 1953 no período áureo do modernismo residencial carioca, apresentando pé-direito confortável, alvenaria robusta e excelente potencial de reforma (retrofit) para transformar a planta de 2 quartos com dependência em um projeto contemporâneo com suíte e cozinha integrada, maximizando a valorização para revenda ou locação de alto padrão.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O certame judicial será realizado por leiloeiro público oficial designado pelo Tribunal de Justiça do Rio de Janeiro. A habilitação requer cadastro prévio e homologação documental no portal eletrônico do certame, recomendando-se a realização dos trâmites com antecedência mínima de 48 a 72 horas úteis.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Pagamento do lance vencedor integralmente mediante guia de depósito judicial vinculada ao processo no TJRJ no prazo estipulado pelo edital de leilão, acrescido da comissão legal de 5% do leiloeiro oficial e custas de expedição da Carta de Arrematação.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Apresentação formal de proposta escrita nos autos processuais antes do início ou encerramento da praça, com sinal mínimo de 25% à vista e o saldo remanescente em até 30 (trinta) parcelas mensais corrigidas monetariamente, mediante constituição de hipoteca judicial gravada na matrícula nº 995653 do 2º RGI.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A aquisição em leilão judicial tem natureza jurídica originária, o que cancela penhoras e hipotecas anteriores averbadas na matrícula. Todavia, a assessoria jurídica especializada é indispensável para auditar a cadeia processual, garantir que todas as partes foram regularmente intimadas e conduzir os atos judiciais até a desocupação e entrega das chaves.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria completa da matrícula nº 995653 do 2º RGI, certidões do IPTU nº 0642600-1, apuração de eventuais quotas condominiais em atraso e checagem de nulidades no edital.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Credenciamento junto ao leiloeiro oficial, estruturação da proposta de parcelamento judicial (Art. 895 CPC) e acompanhamento técnico durante a sessão de lances.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Assinatura tempestiva do auto de arrematação, guia de ITBI perante a Prefeitura do Rio, requerimento da Carta de Arrematação e cancelamento de gravames no 2º RGI.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição e cumprimento célere do Mandado de Imissão na Posse com Oficial de Justiça, garantindo a desocupação forçada caso necessário e a entrega definitiva das chaves ao arrematante.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Consulte nossas publicações técnicas sobre leilões judiciais e conheça nossas áreas integradas de consultoria imobiliária:
          </p>
        ...
        <article className="bg-gradient-to-br from-midnight-light to-midnight rounded-3xl p-8 sm:p-12 border border-bronze/30 text-center space-y-6 shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Leblon%20Rua%20General%20Urquiza%20117%20Apto%20501"
...
export default LeblonGeneralUrquiza117AuctionPage;
