...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1785338049434.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface CentroRiachuelo220AuctionPageProps {
  onBack?: () => void;
}

const CentroRiachuelo220AuctionPage: React.FC<CentroRiachuelo220AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['centro-riachuelo-220'] || editaisData['copacabana-atlantica'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://www.juniorsadvogados.com.br/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/centro/apartamento/rua-riachuelo-220/";
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%201103%20na%20Rua%20Riachuelo%20220%20no%20Centro."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço:</strong> Rua Riachuelo, nº 220, Apto 1103 — Centro, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 80.801 do Cartório do 2º Ofício de Registro de Imóveis da cidade do Rio de Janeiro (2º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 097801</li>
                <li><strong className="text-white">Área Edificada / Útil:</strong> 33 metros quadrados (33 m²)</li>
                <li><strong className="text-white">Posição:</strong> Apartamento de frente para a rua principal</li>
                <li><strong className="text-white">Distribuição Interna:</strong> Kitnet composta por pequena cozinha e banheiro com azulejos em meia parede e piso antigo, corredor e "salão" com taco e janela de alumínio (precisa de reformas)</li>
                <li><strong className="text-white">Edificação (Ano 1967):</strong> Utilização residencial, no alinhamento da via pública, porteiro 24 horas e circuito interno de TV, 2 elevadores (capacidade para 6 passageiros cada) e salão de festas. Acesso por escada com 5 degraus</li>
                <li><strong className="text-white">Bairro:</strong> Centro — Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 138.524,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 138.524,00 (31/08/2026 às 12:50h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 69.262,00 (03/09/2026 às 12:50h) — desconto de 50% do valor da avaliação</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Caracterização da Região e Potencial de Investimento no Centro do Rio de Janeiro
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Riachuelo é uma das vias mais conhecidas e tradicionais do Centro do Rio de Janeiro, conectando o polo cultural da Lapa e Centro Financeiro à Zona Sul e à Glória. A região conta com excelente infraestrutura de transporte público (metrô, linhas de ônibus para todas as zonas da cidade), proximidade a universidades, sedes corporativas, tribunais e ampla variedade de comércio, supermercados e serviços.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Kitnets e apartamentos compactos de 33 m² de frente para a rua possuem altíssima demanda e liquidez para locação residencial (estudantes, servidores públicos e jovens profissionais) e locação por temporada. Por necessitar de reformas em seu acabamento interno (azulejos, piso e modernização da cozinha/banheiro), o imóvel oferece uma excelente margem de agregação de valor para investidores voltados ao ganho patrimonial (retrofit) e geração de renda com aluguel.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base">
              Oportunidade de Aquisição com 50% de Desconto em 2º Leilão
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação oficial de R$ 138.524,00, a abertura do 2º Leilão pelo valor inicial de R$ 69.262,00 representa um ponto de entrada altamente atrativo em uma região central consolidada, permitindo que o investimento em reforma seja absorvido pela margem de desconto na arrematação.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Nossa equipe realiza due diligence integral da Matrícula nº 80.801 do Cartório do 2º Ofício de Registro de Imóveis do Rio de Janeiro, verificação da inscrição municipal IPTU nº 097801 e análise detalhada dos autos processuais no TJRJ, assegurando que o arrematante não responda por penhoras, hipotecas ou dívidas tributárias anteriores à arrematação, com plena sub-rogação dos débitos tributários no preço pago (art. 130, parágrafo único, do CTN).
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Auditoria jurídica completa da matrícula nº 80.801 (2º RGI/RJ), ônus processuais e certidões fiscais (IPTU 097801).
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Habilitação segura perante o leiloeiro oficial e planejamento financeiro para disputa no 1º ou 2º Leilão.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Acompanhamento da assinatura do Auto de Arrematação, expedição da guia de depósito e pagamento de custas.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Expedição da Carta de Arrematação, registro no 2º RGI e providências para Imissão na Posse do imóvel.
              </p>
            </div>
          </div>
        </article>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%201103%20na%20Rua%20Riachuelo%20220%20no%20Centro."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20da%20Rua%20Riachuelo%20220%20no%20Centro."
                target="_blank"
                rel="noopener noreferrer"
...
export default CentroRiachuelo220AuctionPage;
