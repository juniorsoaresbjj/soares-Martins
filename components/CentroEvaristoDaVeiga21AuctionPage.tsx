...
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1789601885139.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface CentroEvaristoDaVeiga21AuctionPageProps {
  onBack?: () => void;
}

const CentroEvaristoDaVeiga21AuctionPage: React.FC<CentroEvaristoDaVeiga21AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['centro-evaristo-da-veiga-21-apto-503'];
  const item = (editalEntry && editalEntry[language]) ? editalEntry[language] : (editalEntry ? editalEntry.pt : {
    ...
    val: 'R$ 160.275,10',
    p2Val: 'R$ 80.137,55',
    description: 'Apartamento residencial compacto com 27 m² de área privativa situado no 5º pavimento (unidade 503) do edifício situado na Rua Evaristo da Veiga nº 21, no coração do Centro histórico e financeiro do Rio de Janeiro.',
    checklist: [],
    modal: { title: 'Resumo Estruturado do Edital', sections: [] },
    faqs: []
  });

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/centro/apartamento/rua-evaristo-da-veiga-21-apto-503/";
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20503%20na%20Rua%20Evaristo%20da%20Veiga%2021%20no%20Centro%20do%20Rio."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Rua Evaristo da Veiga, nº 21, Apartamento 503 — Centro, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Bairro / Região:</strong> Centro Histórico e Cultural (adstrito à Cinelândia e Lapa)</li>
                <li><strong className="text-white">Andar e Posição:</strong> 5º pavimento, unidade 503</li>
                <li><strong className="text-white">Área Edificada Privativa:</strong> 27 metros quadrados (27 m²)</li>
                <li><strong className="text-white">Estrutura Construtiva:</strong> Edifício construído em concreto armado e alvenaria de tijolos com aproximadamente 80 anos de idade</li>
                <li><strong className="text-white">Pavimentos e Unidades:</strong> Edifício com 07 (sete) andares e 49 (quarenta e nove) salas comerciais e moradia (uso misto residencial e corporativo)</li>
                <li><strong className="text-white">Lojas no Térreo:</strong> 02 (duas) lojas comerciais integradas à fachada</li>
                <li><strong className="text-white">Portaria e Entrada:</strong> Porta social em ferro, pequeno hall de entrada com piso nobre em granito preto</li>
                <li><strong className="text-white">Elevadores:</strong> Instalados 02 (dois) elevadores sociais novos recentemente modernizados</li>
                <li><strong className="text-white">Segurança e Monitoramento:</strong> Circuito interno de câmeras (CFTV) em todos os andares e dentro dos elevadores</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Devidamente registrado, dimensionado e caracterizado no 7º Ofício de Registro de Imóveis do Rio de Janeiro (7º RGI/RJ) sob a matrícula nº 19262-2</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 0704066-0</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Judicial:</strong> R$ 160.275,10 (homologada nos autos)</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 160.275,10 (26/10/2026 às 12:00h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 80.137,55 (05/11/2026 às 12:00h) — economia de R$ 80.137,55</li>
                <li><strong className="text-white">Regra da 2ª Praça:</strong> Terá início obrigatório com 50% do valor da avaliação oficial homologada</li>
                <li><strong className="text-white">Condições de Arrematação:</strong> Pagamento à vista via depósito judicial no TJRJ ou proposta formal de parcelamento com garantia hipotecária conforme Artigo 895 do Código de Processo Civil</li>
              </ul>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Contexto de Mercado: Cinelândia, Reviver Centro e Preço por Metro Quadrado
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Rua Evaristo da Veiga é um dos endereços mais tradicionais e historicamente emblemáticos do Centro do Rio de Janeiro. Localizada a poucos passos do Theatro Municipal, da Biblioteca Nacional, da Câmara Municipal (Palácio Pedro Ernesto), do Passeio Público e da Cinelândia, a via serve de elo imediato entre o centro institucional/financeiro e a efervescência cultural e gastronômica da Lapa.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Com as incentivos fiscais e urbanísticos decorrentes das leis do programa <strong>Reviver Centro</strong> da Cidade do Rio de Janeiro, a procura por unidades residenciais compactas na região explodiu. Estudantes de universidades vizinhas (UFRJ, IFCS, FACHA, FGV), servidores da Justiça, estagiários, advogados e funcionários do polo empresarial da Avenida Rio Branco e Presidente Vargas buscam avidamente apartamentos pequenos que eliminem o desgaste do trânsito metropolitano.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Sob a perspectiva de investimento, o patamar financeiro deste leilão é um marco: a abertura da 2ª Praça em <strong>R$ 80.137,55</strong> para uma unidade privativa de 27 m² representa um custo de aquisição de meros <strong>R$ 2.968,05 por metro quadrado</strong>. Trata-se de um valor praticamente inexistente no mercado livre carioca para edifícios guarnecidos por 2 elevadores sociais novos, circuito de CFTV e portaria estruturada.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Oportunidade a ~R$ 2.968/m² no Coração do Rio
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com desconto integral de 50% na 2ª praça e lance inicial em pouco mais de R$ 80 mil, o apartamento 503 viabiliza retorno financeiro ímpar, seja para locação tradicional anual (yield acima da média de mercado), locação flexível para profissionais itinerantes ou plataformas de curta temporada para o público cultural da Lapa e Centro Histórico.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O leilão judicial será realizado na modalidade eletrônica (online) através de leiloeiro público oficial designado pelo Tribunal de Justiça do Estado do Rio de Janeiro. A habilitação de arrematantes exige envio prévio de documentação de identificação, comprovante de endereço e certidões no portal do leiloeiro com antecedência mínima recomendada de 48 a 72 horas úteis.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Pagamento do lance vencedor integralmente mediante guia de depósito judicial vinculada aos autos da execução no TJRJ no prazo assinalado pelo magistrado, acrescido de 5% de comissão ao leiloeiro público e eventuais custas cartorárias de homologação.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
                Submissão tempestiva de proposta de pagamento parcelado por escrito antes do encerramento da praça, com entrada de no mínimo 25% à vista e o saldo restante em até 30 (trinta) parcelas mensais corrigidas por índice oficial da Justiça, com hipoteca judicial averbada na matrícula nº 19262-2 no 7º RGI.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A arrematação judicial configura modalidade de aquisição originária da propriedade que purga constrições e gravames anteriores. Todavia, a assessoria jurídica especializada de um escritório com vivência cotidiana no foro carioca é essencial para validar a legalidade do edital, certificar a regularidade de citações e intimações dos coproprietários e assegurar uma posse rápida e pacífica.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Exame rigoroso da Matrícula nº 19262-2 do 7º RGI, certidões fiscais de IPTU nº 0704066-0, passivos de cotas condominiais e regularidade intrínseca do edital.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Credenciamento junto ao leiloeiro oficial, estruturação da proposta parcelada pelo Art. 895 do CPC e cálculo do teto seguro para a disputa de lances.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Acompanhamento da assinatura do auto de arrematação, apuração e guia de ITBI na Prefeitura do Rio, expedição da Carta de Arrematação e ordens de baixa de gravames no 7º RGI.
              </p>
            </div>
            ...
            <div className="bg-midnight/60 p-5 rounded-2xl border border-white/10 space-y-2">
              ...
              <p className="text-xs text-text-muted">
                Requerimento judicial tempestivo do Mandado de Imissão na Posse perante o TJRJ e diligência acompanhada junto ao Oficial de Justiça até a entrega efetiva das chaves.
              </p>
            </div>
          </div>
        </article>
        ...
        {/* FAQ Específica da Rua Evaristo da Veiga 21 */}
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
        ...
        <article className="bg-gradient-to-br from-midnight-light to-midnight rounded-3xl p-8 sm:p-12 border border-bronze/30 text-center space-y-6 shadow-2xl">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <a 
                href="mailto:Juniorsadv@hotmail.com?subject=Consulta%20Juridica%20-%20Leilao%20Centro%20Rua%20Evaristo%20da%20Veiga%2021%20Apto%20503"
...
export default CentroEvaristoDaVeiga21AuctionPage;
