...
import { 
  ...
  ShieldCheck, FileCheck, Landmark, CheckCircle2, Scale, Bus, Waves, Sparkles
} from 'lucide-react';
import SEO from './SEO';
import buildingImage from '../src/assets/images/regenerated_image_1786990089491.png';
import { useLanguage } from '../context/LanguageContext';
import { editalCommon, editaisData } from '../translations/editais';

interface BarraDaTijucaLucioCosta6500AuctionPageProps {
  onBack?: () => void;
}

const BarraDaTijucaLucioCosta6500AuctionPage: React.FC<BarraDaTijucaLucioCosta6500AuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['barra-lucio-costa-6500-apto-203'];
  const item = editalEntry[language] || editalEntry.pt;

  const canonicalUrl = "https://soaresmartinsadv.com/assessoria-leiloes-judiciais-imoveis-rio-de-janeiro/barra-da-tijuca/apartamento/avenida-lucio-costa-6500-apto-203/";
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20do%20apartamento%20203%20no%20Condom%C3%ADnio%20Alfa%20Plaza%20na%20Avenida%20L%C3%BAcio%20Costa%206500%20na%20Barra%20da%20Tijuca."
                    target="_blank"
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                <li><strong className="text-white">Endereço Principal:</strong> Avenida Lúcio Costa, nº 6500, Apto 203 — Condomínio Alfa Plaza — Barra da Tijuca, Rio de Janeiro/RJ</li>
                <li><strong className="text-white">Registro Imobiliário:</strong> Matrícula nº 121.926 do Cartório do 9º Ofício de Registro de Imóveis do Rio de Janeiro (9º RGI/RJ)</li>
                <li><strong className="text-white">Inscrição Municipal (IPTU):</strong> 1.690.545-7</li>
                <li><strong className="text-white">Área Privativa / Edificada:</strong> 60 metros quadrados (60 m²)</li>
                <li><strong className="text-white">Posição do Imóvel:</strong> Frente</li>
                <li><strong className="text-white">Condomínio / Empreendimento:</strong> Alfa Plaza (Complexo Alfa Barra)</li>
                <li><strong className="text-white">Comodidades do Prédio:</strong> Elevadores sociais e de serviço, churrasqueira, ônibus executivo do condomínio, clubes, complexo de piscinas, portaria e segurança 24 horas, comércio e serviços no entorno</li>
                <li><strong className="text-white">Bairro / Localização:</strong> Barra da Tijuca (Orla Marítima — Posto 7) — Rio de Janeiro/RJ</li>
              </ul>
            </div>
            ...
            <div className="bg-midnight/60 p-6 rounded-2xl border border-white/10 space-y-3">
              ...
              <ul className="text-xs sm:text-sm text-text-muted space-y-2">
                ...
                <li><strong className="text-white">Valor da Avaliação Oficial:</strong> R$ 850.000,00</li>
                <li><strong className="text-white">Lance Mínimo 1ª Praça (100%):</strong> R$ 850.000,00 (27/08/2026 às 12:20h)</li>
                <li><strong className="text-white">Lance Mínimo 2ª Praça (50%):</strong> R$ 425.000,00 (01/09/2026 às 12:20h) — desconto expressivo de 50%</li>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-6">
          <div className="flex items-center gap-3 text-bronze">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-white font-bold">
              Caracterização da Região e Potencial de Investimento na Orla da Barra da Tijuca
            </h2>
          </div>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A Avenida Lúcio Costa (antiga Avenida Sernambetiba) representa a via litorânea mais nobre e desejada da Barra da Tijuca, estendendo-se por quilômetros de praia de águas cristalinas, calçadão esportivo e quiosques gastronômicos de alto padrão.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            O Condomínio Alfa Plaza destaca-se por sua localização privilegiada de frente para o mar (Posto 7) e pela excepcional conveniência oferecida aos moradores. Entre os grandes diferenciais estão o serviço de <strong>ônibus executivo exclusivo do condomínio</strong> com itinerários diretos para o Centro da Cidade, Zona Sul (Ipanema, Leblon, Copacabana, Botafogo) e principais centros comerciais, além de acesso a clubes privativos com quadras de tênis, poliesportivas, complexo de piscinas adulto e infantil, churrasqueiras, saunas e segurança armada 24 horas.
          </p>

          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            Com 60 m² e posição de frente, a unidade 203 reúne metragem versátil e alta liquidez no mercado imobiliário carioca, sendo altamente atrativa tanto para moradia própria quanto para locação anual ou por temporada com rentabilidade expressiva acima da média de mercado.
          </p>
          ...
          <div className="p-6 bg-bronze/10 border border-bronze/30 rounded-2xl space-y-2">
            <div className="text-bronze font-serif font-bold text-base flex items-center gap-2">
              <Sparkles size={18} /> Oportunidade Única de Entrada com 50% de Desconto na 2ª Praça
            </div>
            <p className="text-xs sm:text-sm text-text-muted leading-relaxed">
              Com avaliação judicial homologada em R$ 850.000,00, a abertura da 2ª praça por R$ 425.000,00 proporciona uma margem de segurança e rentabilidade patrimonial excepcional para arrematantes e investidores na orla marítima da Barra da Tijuca.
            </p>
          </div>
        </article>
        ...
        <article className="bg-midnight-light/30 rounded-3xl p-8 sm:p-12 border border-white/10 text-left space-y-8">
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed">
            A participação em leilões judiciais imobiliários exige rigorosa due diligence prévia. O escritório Soares Martins Advogados conduz auditoria jurídica completa sobre a Matrícula nº 121.926 do 9º RGI/RJ, apuração de débitos de IPTU (1.690.545-7), levantamento de débitos condominiais e exame aprofundado dos autos processuais no TJRJ, assegurando a correta aplicação do art. 130, parágrafo único, do CTN (sub-rogação tributária no preço) e a imissão segura na posse do imóvel.
          </p>
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20do%20apartamento%20203%20no%20Alfa%20Plaza%20na%20Avenida%20L%C3%BAcio%20Costa%206500%20na%20Barra%20da%20Tijuca."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 z-[1000] bg-midnight/90 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-midnight-light border border-bronze/30 rounded-3xl p-6 sm:p-8 max-w-2xl w-full text-left space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-white/10 flex justify-end gap-3">
              ...
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20solicitar%20o%20parecer%20completo%20do%20edital%20do%20apartamento%20203%20no%20Condom%C3%ADnio%20Alfa%20Plaza%20na%20Avenida%20L%C3%BAcio%20Costa%206500%20na%20Barra%20da%20Tijuca."
                target="_blank"
                rel="noopener noreferrer"
...
export default BarraDaTijucaLucioCosta6500AuctionPage;
