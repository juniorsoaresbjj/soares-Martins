...
const AtlanticaAuctionPage: React.FC<AtlanticaAuctionPageProps> = () => {
  ...
  const editalEntry = editaisData['copacabana-atlantica'] || editaisData['copacabana-viveiros'];
            ...
            <div className="lg:col-span-5 bg-midnight/80 rounded-2xl p-6 sm:p-8 border border-bronze/30 space-y-6 shadow-xl text-left">
              <div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 space-y-3">
                  ...
                  <a 
                    href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20o%20leil%C3%A3o%20da%20Av.%20Atl%C3%A2ntica."
                    target="_blank"
        ...
        <section className="bg-bronze p-8 sm:p-12 md:p-14 rounded-3xl text-midnight text-center shadow-2xl border border-bronze/30">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
              <a 
                href="https://wa.me/5521979549241?text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20assessoria%20jur%C3%ADdica%20para%20o%20leil%C3%A3o%20da%20Av.%20Atl%C3%A2ntica."
                target="_blank"
                rel="noopener noreferrer"
