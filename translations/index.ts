...
export const translations = {
  pt: {
    ...
    about: {
      ...
      desc4: 'Além da atuação em direito condominial, o escritório também atua no direito patrimonial, oferecendo suporte jurídico estratégico para proteção, organização e segurança de bens e interesses.',
      desc5: 'Mais do que um escritório de advocacia, somos parceiros estratégicos na gestão e na proteção patrimonial, promovendo segurança jurídica, equilíbrio nas relações e eficiência na administração de patrimônios.',
    ...
    services_page: {
      ...
      subtitle: 'Especialização Estratégica em Direito Imobiliário, Condominial e Patrimonial.',
      desc: 'Atuação altamente técnica voltada à proteção patrimonial, governança condominial e segurança jurídica de empreendimentos imobiliários residenciais e comerciais.',
      ...
      step1_desc: 'Mapeamento do histórico jurídico, financeiro e administrativo para identificação de riscos estruturais.',
  ...
  es: {
    ...
    about: {
      ...
      desc4: 'Además de actuar en derecho de condominios, el despacho también actúa en derecho patrimonial, ofreciendo soporte jurídico estratégico para la protección, organización y seguridad de bienes e intereses.',
      desc5: 'Más que un despacho de abogados, somos socios estratégicos en la gestión y protección patrimonial, promoviendo seguridad jurídica, equilibrio en las relaciones y eficiencia en la administración de patrimonios.',
      card1: 'Compromiso',
    ...
    services_page: {
      ...
      subtitle: 'Especialización Estratégica en Derecho Inmobiliario, Condominial y Patrimonial.',
      desc: 'Actuación altamente técnica enfocada en la protección patrimonial, gobernanza de condominios y seguridad jurídica de emprendimientos inmobiliarios residenciales y comerciales.',
